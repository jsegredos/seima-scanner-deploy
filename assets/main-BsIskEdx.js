...
</body></html>`;try{const i={"Content-Type":"application/json"};this.emailConfig.SEIMA_EMAIL_API_KEY&&(i["X-Api-Key"]=this.emailConfig.SEIMA_EMAIL_API_KEY),console.log("📧 Sending password reset email to:",e);const a=await fetch(s,{method:"POST",headers:i,body:JSON.stringify({to:e,toName:r,subject:"Your Seima Password Reset Code",html:l,fromName:this.emailConfig.FROM_NAME||"Seima Team"})}),d=await a.json().catch(()=>({}));a.ok?console.log("✅ Password reset email sent to:",e):console.error("Password reset email failed:",a.status,d)}catch(i){console.error("Failed to send password reset email:",i)}}async sendVerificationEmail(e,t,o){if(!this.emailConfig){console.warn("Email config not set, cannot send verification email");return}const s=this.emailConfig.SEIMA_EMAIL_API_URL;if(!s){console.error("SEIMA_EMAIL_API_URL not configured, cannot send verification email");return}const r=t||"there",n=new Date().getFullYear(),i=e.toLowerCase().endsWith("@seima.com.au")?`<p style="margin:16px 0 0;color:#166534;font-size:14px;line-height:1.6;background:#f0fdf4;border:1px solid #bbf7d0;border-radius:6px;padding:12px 16px;">
          <strong>Staff access:</strong> Once verified, you will have access to staff features including competitor cross-referencing.</p>`:"",a=`<!DOCTYPE html>
<html><head><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1"></head>
<body style="margin:0;padding:0;background:#f8f8fa;font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Roboto,sans-serif;">
<table width="100%" cellpadding="0" cellspacing="0" style="background:#f8f8fa;padding:32px 0;">
<tr><td align="center">
<table width="480" cellpadding="0" cellspacing="0" style="background:#ffffff;border-radius:8px;overflow:hidden;box-shadow:0 2px 8px rgba(0,0,0,0.08);">
  ...
  <tr><td style="background:#f8f8fa;padding:16px 32px;text-align:center;border-top:1px solid #e5e7eb;">
    ...
    `;this.showModal(t),this.setupChangePasswordHandlers(e)}setupChangePasswordHandlers(e){var o;const t=document.getElementById("change-password-form");t==null||t.addEventListener("submit",async s=>{var a,d,u;s.preventDefault();const r=(a=document.getElementById("current-password"))==null?void 0:a.value,n=(d=document.getElementById("new-password"))==null?void 0:d.value,l=(u=document.getElementById("confirm-password"))==null?void 0:u.value;if(n!==l){this.showMessage("New passwords do not match");return}if(n.length<8){this.showMessage("New password must be at least 8 characters");return}if(!/\d/.test(n)){this.showMessage("New password must contain at least one number");return}this.setLoading("password-submit",!0);const i=await authService.changePassword(r,n);this.setLoading("password-submit",!1),i.success?(this.showMessage("Password changed successfully!","success"),setTimeout(()=>{this.closeModal(),e&&e()},1500)):this.showMessage(i.error)}),(o=document.getElementById("password-cancel"))==null||o.addEventListener("click",()=>this.closeModal())}showUserMenu(e,t={}){var i,a,d;const o=authService.getCurrentUser();if(!o)return;const s=document.getElementById("auth-user-menu");if(s){s.remove();return}const n=`
    ...
    `;document.body.insertAdjacentHTML("beforeend",n);const l=document.getElementById("auth-user-menu");if(e){const u=e.getBoundingClientRect();l.style.position="fixed",l.style.top=u.bottom+8+"px",l.style.right=window.innerWidth-u.right+"px"}(i=document.getElementById("user-menu-profile"))==null||i.addEventListener("click",()=>{l.remove(),this.showEditProfile()}),(a=document.getElementById("user-menu-password"))==null||a.addEventListener("click",()=>{l.remove(),this.showChangePassword()}),(d=document.getElementById("user-menu-logout"))==null||d.addEventListener("click",()=>{l.remove(),authService.logout(),t.onLogout&&t.onLogout()}),setTimeout(()=>{const u=h=>{!l.contains(h.target)&&h.target!==e&&(l.remove(),document.removeEventListener("click",u))};document.addEventListener("click",u)},10)}showModal(e){var o;this.closeModal();const t=document.createElement("div");t.innerHTML=e,document.body.appendChild(t.firstElementChild),this.currentModal=document.getElementById("auth-modal"),(o=document.getElementById("auth-close"))==null||o.addEventListener("click",()=>this.closeModal()),document.addEventListener("keydown",this.escHandler=s=>{s.key==="Escape"&&this.closeModal()})}closeModal(){this.currentModal&&(this.currentModal.remove(),this.currentModal=null),this.escHandler&&document.removeEventListener("keydown",this.escHandler)}showMessage(e,t="error"){const o=document.getElementById("auth-message");o&&(o.innerHTML=`<div class="auth-message ${t}">${e}</div>`)}setLoading(e,t){const o=document.getElementById(e);o&&(t?(o.disabled=!0,o.dataset.originalText=o.textContent,o.innerHTML='<span class="auth-spinner"></span>Please wait...'):(o.disabled=!1,o.textContent=o.dataset.originalText||"Submit"))}setupLoginHandlers(e){var o,s,r;const t=document.getElementById("login-form");t==null||t.addEventListener("submit",async n=>{var u,h,p,m;n.preventDefault();const l=(u=document.getElementById("login-email"))==null?void 0:u.value,i=(h=document.getElementById("login-password"))==null?void 0:h.value,a=((p=document.getElementById("login-remember"))==null?void 0:p.checked)||!1;this.setLoading("login-submit",!0);const d=await authService.login(l,i,a);this.setLoading("login-submit",!1),d.success?(this.closeModal(),e&&e(d.user),(m=this.pendingAction)!=null&&m.callback&&(this.pendingAction.callback(d.user),this.pendingAction=null)):this.showMessage(d.error)}),(o=document.getElementById("show-register"))==null||o.addEventListener("click",()=>this.showRegister()),(s=document.getElementById("show-forgot"))==null||s.addEventListener("click",()=>this.showForgotPassword()),(r=document.getElementById("show-verify"))==null||r.addEventListener("click",()=>this.showVerifyEmail())}setupRegisterHandlers(){var t;const e=document.getElementById("register-form");e==null||e.addEventListener("submit",async o=>{var d,u,h,p,m;o.preventDefault();const s=(d=document.getElementById("register-name"))==null?void 0:d.value,r=(u=document.getElementById("register-email"))==null?void 0:u.value,n=(h=document.getElementById("register-password"))==null?void 0:h.value,l=((p=document.getElementById("register-position"))==null?void 0:p.value)||"",i=((m=document.getElementById("register-phone"))==null?void 0:m.value)||"";this.setLoading("register-submit",!0);const a=await authService.register(r,n,s,l,i);this.setLoading("register-submit",!1),a.success?(this.closeModal(),this.showVerifyEmail(r.trim(),()=>{})):this.showMessage(a.error)}),(t=document.getElementById("show-login"))==null||t.addEventListener("click",()=>this.showLogin())}setupForgotHandlers(){var t;const e=document.getElementById("forgot-form");e==null||e.addEventListener("submit",async o=>{var n;o.preventDefault();const s=(n=document.getElementById("forgot-email"))==null?void 0:n.value;this.setLoading("forgot-submit",!0);const r=await authService.requestPasswordReset(s);this.setLoading("forgot-submit",!1),r.success?(this.showMessage("If this email exists, a reset code has been sent.","success"),setTimeout(()=>this.showResetPassword(s),2e3)):this.showMessage(r.error)}),(t=document.getElementById("show-login-back"))==null||t.addEventListener("click",()=>this.showLogin())}setupResetHandlers(){var t;const e=document.getElementById("reset-form");e==null||e.addEventListener("submit",async o=>{var i,a,d;o.preventDefault();const s=(i=document.getElementById("reset-email"))==null?void 0:i.value,r=(a=document.getElementById("reset-code"))==null?void 0:a.value,n=(d=document.getElementById("reset-new-password"))==null?void 0:d.value;this.setLoading("reset-submit",!0);const l=await authService.resetPassword(s,r,n);this.setLoading("reset-submit",!1),l.success?(this.showMessage("Password reset successfully! You can now sign in.","success"),setTimeout(()=>this.showLogin(),1500)):this.showMessage(l.error)}),(t=document.getElementById("show-login-back"))==null||t.addEventListener("click",()=>this.showLogin())}setupVerifyEmailHandlers(e){var o,s;const t=document.getElementById("verify-form");t==null||t.addEventListener("submit",async r=>{var a,d;r.preventDefault();const n=(a=document.getElementById("verify-email"))==null?void 0:a.value,l=(d=document.getElementById("verify-code"))==null?void 0:d.value;this.setLoading("verify-submit",!0);const i=await authService.verifyEmail(n,l);this.setLoading("verify-submit",!1),i.success?(this.showMessage("Email verified successfully!","success"),setTimeout(()=>{this.closeModal(),e&&e(),this.showLogin()},1500)):this.showMessage(i.error)}),(o=document.getElementById("verify-resend"))==null||o.addEventListener("click",async()=>{var l;const r=(l=document.getElementById("verify-email"))==null?void 0:l.value;if(!r){this.showMessage("Please enter your email first");return}this.setLoading("verify-resend",!0);const n=await authService.requestEmailVerification(r);this.setLoading("verify-resend",!1),this.showMessage(n.success?"Verification code sent! Check your email.":n.error,n.success?"success":"error")}),(s=document.getElementById("verify-to-login"))==null||s.addEventListener("click",()=>this.showLogin())}getInitials(e){if(!e)return"?";const t=e.split(" ");return t.length>=2?(t[0][0]+t[t.length-1][0]).toUpperCase():e.substring(0,2).toUpperCase()}requireAuth(e,t="continue"){authService.isLoggedIn()?e(authService.getCurrentUser()):this.showLogin(e)}}const authUI=new AuthUI;function isArray(c){return Array.isArray?Array.isArray(c):getTag(c)==="[object Array]"}function baseToString(c){if(typeof c=="string")return c;let e=c+"";return e=="0"&&1/c==-1/0?"-0":e}function toString(c){return c==null?"":baseToString(c)}function isString(c){return typeof c=="string"}function isNumber(c){return typeof c=="number"}function isBoolean(c){return c===!0||c===!1||isObjectLike(c)&&getTag(c)=="[object Boolean]"}function isObject(c){return typeof c=="object"}function isObjectLike(c){return isObject(c)&&c!==null}function isDefined(c){return c!=null}function isBlank(c){return!c.trim().length}function getTag(c){return c==null?c===void 0?"[object Undefined]":"[object Null]":Object.prototype.toString.call(c)}const INCORRECT_INDEX_TYPE="Incorrect 'index' type",LOGICAL_SEARCH_INVALID_QUERY_FOR_KEY=c=>`Invalid value for key ${c}`,PATTERN_LENGTH_TOO_LARGE=c=>`Pattern length exceeds max of ${c}.`,MISSING_KEY_PROPERTY=c=>`Missing ${c} property in key`,INVALID_KEY_WEIGHT_VALUE=c=>`Property 'weight' in key '${c}' must be a positive integer`,hasOwn=Object.prototype.hasOwnProperty;class KeyStore{constructor(e){this._keys=[],this._keyMap={};let t=0;e.forEach(o=>{let s=createKey(o);this._keys.push(s),this._keyMap[s.id]=s,t+=s.weight}),this._keys.forEach(o=>{o.weight/=t})}get(e){return this._keyMap[e]}keys(){return this._keys}toJSON(){return JSON.stringify(this._keys)}}function createKey(c){let e=null,t=null,o=null,s=1,r=null;if(isString(c)||isArray(c))o=c,e=createKeyPath(c),t=createKeyId(c);else{if(!hasOwn.call(c,"name"))throw new Error(MISSING_KEY_PROPERTY("name"));const n=c.name;if(o=n,hasOwn.call(c,"weight")&&(s=c.weight,s<=0))throw new Error(INVALID_KEY_WEIGHT_VALUE(n));e=createKeyPath(n),t=createKeyId(n),r=c.getFn}return{path:e,id:t,weight:s,src:o,getFn:r}}function createKeyPath(c){return isArray(c)?c:c.split(".")}function createKeyId(c){return isArray(c)?c.join("."):c}function get(c,e){let t=[],o=!1;const s=(r,n,l)=>{if(isDefined(r))if(!n[l])t.push(r);else{let i=n[l];const a=r[i];if(!isDefined(a))return;if(l===n.length-1&&(isString(a)||isNumber(a)||isBoolean(a)))t.push(toString(a));else if(isArray(a)){o=!0;for(let d=0,u=a.length;d<u;d+=1)s(a[d],n,l+1)}else n.length&&s(a,n,l+1)}};return s(c,isString(e)?e.split("."):e,0),o?t:t[0]}const MatchOptions={includeMatches:!1,findAllMatches:!1,minMatchCharLength:1},BasicOptions={isCaseSensitive:!1,ignoreDiacritics:!1,includeScore:!1,keys:[],shouldSort:!0,sortFn:(c,e)=>c.score===e.score?c.idx<e.idx?-1:1:c.score<e.score?-1:1},FuzzyOptions={location:0,threshold:.6,distance:100},AdvancedOptions={useExtendedSearch:!1,getFn:get,ignoreLocation:!1,ignoreFieldNorm:!1,fieldNormWeight:1};var Config={...BasicOptions,...MatchOptions,...FuzzyOptions,...AdvancedOptions};const SPACE=/[^ ]+/g;function norm(c=1,e=3){const t=new Map,o=Math.pow(10,e);return{get(s){const r=s.match(SPACE).length;if(t.has(r))return t.get(r);const n=1/Math.pow(r,.5*c),l=parseFloat(Math.round(n*o)/o);return t.set(r,l),l},clear(){t.clear()}}}class FuseIndex{constructor({getFn:e=Config.getFn,fieldNormWeight:t=Config.fieldNormWeight}={}){this.norm=norm(t,3),this.getFn=e,this.isCreated=!1,this.setIndexRecords()}setSources(e=[]){this.docs=e}setIndexRecords(e=[]){this.records=e}setKeys(e=[]){this.keys=e,this._keysMap={},e.forEach((t,o)=>{this._keysMap[t.id]=o})}create(){this.isCreated||!this.docs.length||(this.isCreated=!0,isString(this.docs[0])?this.docs.forEach((e,t)=>{this._addString(e,t)}):this.docs.forEach((e,t)=>{this._addObject(e,t)}),this.norm.clear())}add(e){const t=this.size();isString(e)?this._addString(e,t):this._addObject(e,t)}removeAt(e){this.records.splice(e,1);for(let t=e,o=this.size();t<o;t+=1)this.records[t].i-=1}getValueForItemAtKeyId(e,t){return e[this._keysMap[t]]}size(){return this.records.length}_addString(e,t){if(!isDefined(e)||isBlank(e))return;let o={v:e,i:t,n:this.norm.get(e)};this.records.push(o)}_addObject(e,t){let o={i:t,$:{}};this.keys.forEach((s,r)=>{let n=s.getFn?s.getFn(e):this.getFn(e,s.path);if(isDefined(n)){if(isArray(n)){let l=[];const i=[{nestedArrIndex:-1,value:n}];for(;i.length;){const{nestedArrIndex:a,value:d}=i.pop();if(isDefined(d))if(isString(d)&&!isBlank(d)){let u={v:d,i:a,n:this.norm.get(d)};l.push(u)}else isArray(d)&&d.forEach((u,h)=>{i.push({nestedArrIndex:h,value:u})})}o.$[r]=l}else if(isString(n)&&!isBlank(n)){let l={v:n,n:this.norm.get(n)};o.$[r]=l}}}),this.records.push(o)}toJSON(){return{keys:this.keys,records:this.records}}}function createIndex(c,e,{getFn:t=Config.getFn,fieldNormWeight:o=Config.fieldNormWeight}={}){const s=new FuseIndex({getFn:t,fieldNormWeight:o});return s.setKeys(c.map(createKey)),s.setSources(e),s.create(),s}function parseIndex(c,{getFn:e=Config.getFn,fieldNormWeight:t=Config.fieldNormWeight}={}){const{keys:o,records:s}=c,r=new FuseIndex({getFn:e,fieldNormWeight:t});return r.setKeys(o),r.setIndexRecords(s),r}function computeScore$1(c,{errors:e=0,currentLocation:t=0,expectedLocation:o=0,distance:s=Config.distance,ignoreLocation:r=Config.ignoreLocation}={}){const n=e/c.length;if(r)return n;const l=Math.abs(o-t);return s?n+l/s:l?1:n}function convertMaskToIndices(c=[],e=Config.minMatchCharLength){let t=[],o=-1,s=-1,r=0;for(let n=c.length;r<n;r+=1){let l=c[r];l&&o===-1?o=r:!l&&o!==-1&&(s=r-1,s-o+1>=e&&t.push([o,s]),o=-1)}return c[r-1]&&r-o>=e&&t.push([o,r-1]),t}const MAX_BITS=32;function search(c,e,t,{location:o=Config.location,distance:s=Config.distance,threshold:r=Config.threshold,findAllMatches:n=Config.findAllMatches,minMatchCharLength:l=Config.minMatchCharLength,includeMatches:i=Config.includeMatches,ignoreLocation:a=Config.ignoreLocation}={}){if(e.length>MAX_BITS)throw new Error(PATTERN_LENGTH_TOO_LARGE(MAX_BITS));const d=e.length,u=c.length,h=Math.max(0,Math.min(o,u));let p=r,m=h;const f=l>1||i,g=f?Array(u):[];let w;for(;(w=c.indexOf(e,m))>-1;){let C=computeScore$1(e,{currentLocation:w,expectedLocation:h,distance:s,ignoreLocation:a});if(p=Math.min(C,p),m=w+d,f){let M=0;for(;M<d;)g[w+M]=1,M+=1}}m=-1;let b=[],y=1,S=d+u;const v=1<<d-1;for(let C=0;C<d;C+=1){let M=0,L=S;for(;M<L;)computeScore$1(e,{errors:C,currentLocation:h+L,expectedLocation:h,distance:s,ignoreLocation:a})<=p?M=L:S=L,L=Math.floor((S-M)/2+M);S=L;let A=Math.max(1,h-L+1),T=n?u:Math.min(h+L,u)+d,k=Array(T+2);k[T+1]=(1<<C)-1;for(let x=T;x>=A;x-=1){let P=x-1,R=t[c.charAt(P)];if(f&&(g[P]=+!!R),k[x]=(k[x+1]<<1|1)&R,C&&(k[x]|=(b[x+1]|b[x])<<1|1|b[x+1]),k[x]&v&&(y=computeScore$1(e,{errors:C,currentLocation:P,expectedLocation:h,distance:s,ignoreLocation:a}),y<=p)){if(p=y,m=P,m<=h)break;A=Math.max(1,2*h-m)}}if(computeScore$1(e,{errors:C+1,currentLocation:h,expectedLocation:h,distance:s,ignoreLocation:a})>p)break;b=k}const E={isMatch:m>=0,score:Math.max(.001,y)};if(f){const C=convertMaskToIndices(g,l);C.length?i&&(E.indices=C):E.isMatch=!1}return E}function createPatternAlphabet(c){let e={};for(let t=0,o=c.length;t<o;t+=1){const s=c.charAt(t);e[s]=(e[s]||0)|1<<o-t-1}return e}const stripDiacritics=String.prototype.normalize?c=>c.normalize("NFD").replace(/[\u0300-\u036F\u0483-\u0489\u0591-\u05BD\u05BF\u05C1\u05C2\u05C4\u05C5\u05C7\u0610-\u061A\u064B-\u065F\u0670\u06D6-\u06DC\u06DF-\u06E4\u06E7\u06E8\u06EA-\u06ED\u0711\u0730-\u074A\u07A6-\u07B0\u07EB-\u07F3\u07FD\u0816-\u0819\u081B-\u0823\u0825-\u0827\u0829-\u082D\u0859-\u085B\u08D3-\u08E1\u08E3-\u0903\u093A-\u093C\u093E-\u094F\u0951-\u0957\u0962\u0963\u0981-\u0983\u09BC\u09BE-\u09C4\u09C7\u09C8\u09CB-\u09CD\u09D7\u09E2\u09E3\u09FE\u0A01-\u0A03\u0A3C\u0A3E-\u0A42\u0A47\u0A48\u0A4B-\u0A4D\u0A51\u0A70\u0A71\u0A75\u0A81-\u0A83\u0ABC\u0ABE-\u0AC5\u0AC7-\u0AC9\u0ACB-\u0ACD\u0AE2\u0AE3\u0AFA-\u0AFF\u0B01-\u0B03\u0B3C\u0B3E-\u0B44\u0B47\u0B48\u0B4B-\u0B4D\u0B56\u0B57\u0B62\u0B63\u0B82\u0BBE-\u0BC2\u0BC6-\u0BC8\u0BCA-\u0BCD\u0BD7\u0C00-\u0C04\u0C3E-\u0C44\u0C46-\u0C48\u0C4A-\u0C4D\u0C55\u0C56\u0C62\u0C63\u0C81-\u0C83\u0CBC\u0CBE-\u0CC4\u0CC6-\u0CC8\u0CCA-\u0CCD\u0CD5\u0CD6\u0CE2\u0CE3\u0D00-\u0D03\u0D3B\u0D3C\u0D3E-\u0D44\u0D46-\u0D48\u0D4A-\u0D4D\u0D57\u0D62\u0D63\u0D82\u0D83\u0DCA\u0DCF-\u0DD4\u0DD6\u0DD8-\u0DDF\u0DF2\u0DF3\u0E31\u0E34-\u0E3A\u0E47-\u0E4E\u0EB1\u0EB4-\u0EB9\u0EBB\u0EBC\u0EC8-\u0ECD\u0F18\u0F19\u0F35\u0F37\u0F39\u0F3E\u0F3F\u0F71-\u0F84\u0F86\u0F87\u0F8D-\u0F97\u0F99-\u0FBC\u0FC6\u102B-\u103E\u1056-\u1059\u105E-\u1060\u1062-\u1064\u1067-\u106D\u1071-\u1074\u1082-\u108D\u108F\u109A-\u109D\u135D-\u135F\u1712-\u1714\u1732-\u1734\u1752\u1753\u1772\u1773\u17B4-\u17D3\u17DD\u180B-\u180D\u1885\u1886\u18A9\u1920-\u192B\u1930-\u193B\u1A17-\u1A1B\u1A55-\u1A5E\u1A60-\u1A7C\u1A7F\u1AB0-\u1ABE\u1B00-\u1B04\u1B34-\u1B44\u1B6B-\u1B73\u1B80-\u1B82\u1BA1-\u1BAD\u1BE6-\u1BF3\u1C24-\u1C37\u1CD0-\u1CD2\u1CD4-\u1CE8\u1CED\u1CF2-\u1CF4\u1CF7-\u1CF9\u1DC0-\u1DF9\u1DFB-\u1DFF\u20D0-\u20F0\u2CEF-\u2CF1\u2D7F\u2DE0-\u2DFF\u302A-\u302F\u3099\u309A\uA66F-\uA672\uA674-\uA67D\uA69E\uA69F\uA6F0\uA6F1\uA802\uA806\uA80B\uA823-\uA827\uA880\uA881\uA8B4-\uA8C5\uA8E0-\uA8F1\uA8FF\uA926-\uA92D\uA947-\uA953\uA980-\uA983\uA9B3-\uA9C0\uA9E5\uAA29-\uAA36\uAA43\uAA4C\uAA4D\uAA7B-\uAA7D\uAAB0\uAAB2-\uAAB4\uAAB7\uAAB8\uAABE\uAABF\uAAC1\uAAEB-\uAAEF\uAAF5\uAAF6\uABE3-\uABEA\uABEC\uABED\uFB1E\uFE00-\uFE0F\uFE20-\uFE2F]/g,""):c=>c;class BitapSearch{constructor(e,{location:t=Config.location,threshold:o=Config.threshold,distance:s=Config.distance,includeMatches:r=Config.includeMatches,findAllMatches:n=Config.findAllMatches,minMatchCharLength:l=Config.minMatchCharLength,isCaseSensitive:i=Config.isCaseSensitive,ignoreDiacritics:a=Config.ignoreDiacritics,ignoreLocation:d=Config.ignoreLocation}={}){if(this.options={location:t,threshold:o,distance:s,includeMatches:r,findAllMatches:n,minMatchCharLength:l,isCaseSensitive:i,ignoreDiacritics:a,ignoreLocation:d},e=i?e:e.toLowerCase(),e=a?stripDiacritics(e):e,this.pattern=e,this.chunks=[],!this.pattern.length)return;const u=(p,m)=>{this.chunks.push({pattern:p,alphabet:createPatternAlphabet(p),startIndex:m})},h=this.pattern.length;if(h>MAX_BITS){let p=0;const m=h%MAX_BITS,f=h-m;for(;p<f;)u(this.pattern.substr(p,MAX_BITS),p),p+=MAX_BITS;if(m){const g=h-MAX_BITS;u(this.pattern.substr(g),g)}}else u(this.pattern,0)}searchIn(e){const{isCaseSensitive:t,ignoreDiacritics:o,includeMatches:s}=this.options;if(e=t?e:e.toLowerCase(),e=o?stripDiacritics(e):e,this.pattern===e){let f={isMatch:!0,score:0};return s&&(f.indices=[[0,e.length-1]]),f}const{location:r,distance:n,threshold:l,findAllMatches:i,minMatchCharLength:a,ignoreLocation:d}=this.options;let u=[],h=0,p=!1;this.chunks.forEach(({pattern:f,alphabet:g,startIndex:w})=>{const{isMatch:b,score:y,indices:S}=search(e,f,g,{location:r+w,distance:n,threshold:l,findAllMatches:i,minMatchCharLength:a,includeMatches:s,ignoreLocation:d});b&&(p=!0),h+=y,b&&S&&(u=[...u,...S])});let m={isMatch:p,score:p?h/this.chunks.length:1};return p&&s&&(m.indices=u),m}}class BaseMatch{constructor(e){this.pattern=e}static isMultiMatch(e){return getMatch(e,this.multiRegex)}static isSingleMatch(e){return getMatch(e,this.singleRegex)}search(){}}function getMatch(c,e){const t=c.match(e);return t?t[1]:null}class ExactMatch extends BaseMatch{constructor(e){super(e)}static get type(){return"exact"}static get multiRegex(){return/^="(.*)"$/}static get singleRegex(){return/^=(.*)$/}search(e){const t=e===this.pattern;return{isMatch:t,score:t?0:1,indices:[0,this.pattern.length-1]}}}class InverseExactMatch extends BaseMatch{constructor(e){super(e)}static get type(){return"inverse-exact"}static get multiRegex(){return/^!"(.*)"$/}static get singleRegex(){return/^!(.*)$/}search(e){const o=e.indexOf(this.pattern)===-1;return{isMatch:o,score:o?0:1,indices:[0,e.length-1]}}}class PrefixExactMatch extends BaseMatch{constructor(e){super(e)}static get type(){return"prefix-exact"}static get multiRegex(){return/^\^"(.*)"$/}static get singleRegex(){return/^\^(.*)$/}search(e){const t=e.startsWith(this.pattern);return{isMatch:t,score:t?0:1,indices:[0,this.pattern.length-1]}}}class InversePrefixExactMatch extends BaseMatch{constructor(e){super(e)}static get type(){return"inverse-prefix-exact"}static get multiRegex(){return/^!\^"(.*)"$/}static get singleRegex(){return/^!\^(.*)$/}search(e){const t=!e.startsWith(this.pattern);return{isMatch:t,score:t?0:1,indices:[0,e.length-1]}}}class SuffixExactMatch extends BaseMatch{constructor(e){super(e)}static get type(){return"suffix-exact"}static get multiRegex(){return/^"(.*)"\$$/}static get singleRegex(){return/^(.*)\$$/}search(e){const t=e.endsWith(this.pattern);return{isMatch:t,score:t?0:1,indices:[e.length-this.pattern.length,e.length-1]}}}class InverseSuffixExactMatch extends BaseMatch{constructor(e){super(e)}static get type(){return"inverse-suffix-exact"}static get multiRegex(){return/^!"(.*)"\$$/}static get singleRegex(){return/^!(.*)\$$/}search(e){const t=!e.endsWith(this.pattern);return{isMatch:t,score:t?0:1,indices:[0,e.length-1]}}}class FuzzyMatch extends BaseMatch{constructor(e,{location:t=Config.location,threshold:o=Config.threshold,distance:s=Config.distance,includeMatches:r=Config.includeMatches,findAllMatches:n=Config.findAllMatches,minMatchCharLength:l=Config.minMatchCharLength,isCaseSensitive:i=Config.isCaseSensitive,ignoreDiacritics:a=Config.ignoreDiacritics,ignoreLocation:d=Config.ignoreLocation}={}){super(e),this._bitapSearch=new BitapSearch(e,{location:t,threshold:o,distance:s,includeMatches:r,findAllMatches:n,minMatchCharLength:l,isCaseSensitive:i,ignoreDiacritics:a,ignoreLocation:d})}static get type(){return"fuzzy"}static get multiRegex(){return/^"(.*)"$/}static get singleRegex(){return/^(.*)$/}search(e){return this._bitapSearch.searchIn(e)}}class IncludeMatch extends BaseMatch{constructor(e){super(e)}static get type(){return"include"}static get multiRegex(){return/^'"(.*)"$/}static get singleRegex(){return/^'(.*)$/}search(e){let t=0,o;const s=[],r=this.pattern.length;for(;(o=e.indexOf(this.pattern,t))>-1;)t=o+r,s.push([o,t-1]);const n=!!s.length;return{isMatch:n,score:n?0:1,indices:s}}}const searchers=[ExactMatch,IncludeMatch,PrefixExactMatch,InversePrefixExactMatch,InverseSuffixExactMatch,SuffixExactMatch,InverseExactMatch,FuzzyMatch],searchersLen=searchers.length,SPACE_RE=/ +(?=(?:[^\"]*\"[^\"]*\")*[^\"]*$)/,OR_TOKEN="|";function parseQuery(c,e={}){return c.split(OR_TOKEN).map(t=>{let o=t.trim().split(SPACE_RE).filter(r=>r&&!!r.trim()),s=[];for(let r=0,n=o.length;r<n;r+=1){const l=o[r];let i=!1,a=-1;for(;!i&&++a<searchersLen;){const d=searchers[a];let u=d.isMultiMatch(l);u&&(s.push(new d(u,e)),i=!0)}if(!i)for(a=-1;++a<searchersLen;){const d=searchers[a];let u=d.isSingleMatch(l);if(u){s.push(new d(u,e));break}}}return s})}const MultiMatchSet=new Set([FuzzyMatch.type,IncludeMatch.type]);class ExtendedSearch{constructor(e,{isCaseSensitive:t=Config.isCaseSensitive,ignoreDiacritics:o=Config.ignoreDiacritics,includeMatches:s=Config.includeMatches,minMatchCharLength:r=Config.minMatchCharLength,ignoreLocation:n=Config.ignoreLocation,findAllMatches:l=Config.findAllMatches,location:i=Config.location,threshold:a=Config.threshold,distance:d=Config.distance}={}){this.query=null,this.options={isCaseSensitive:t,ignoreDiacritics:o,includeMatches:s,minMatchCharLength:r,findAllMatches:l,ignoreLocation:n,location:i,threshold:a,distance:d},e=t?e:e.toLowerCase(),e=o?stripDiacritics(e):e,this.pattern=e,this.query=parseQuery(this.pattern,this.options)}static condition(e,t){return t.useExtendedSearch}searchIn(e){const t=this.query;if(!t)return{isMatch:!1,score:1};const{includeMatches:o,isCaseSensitive:s,ignoreDiacritics:r}=this.options;e=s?e:e.toLowerCase(),e=r?stripDiacritics(e):e;let n=0,l=[],i=0;for(let a=0,d=t.length;a<d;a+=1){const u=t[a];l.length=0,n=0;for(let h=0,p=u.length;h<p;h+=1){const m=u[h],{isMatch:f,indices:g,score:w}=m.search(e);if(f){if(n+=1,i+=w,o){const b=m.constructor.type;MultiMatchSet.has(b)?l=[...l,...g]:l.push(g)}}else{i=0,n=0,l.length=0;break}}if(n){let h={isMatch:!0,score:i/n};return o&&(h.indices=l),h}}return{isMatch:!1,score:1}}}const registeredSearchers=[];function register(...c){registeredSearchers.push(...c)}function createSearcher(c,e){for(let t=0,o=registeredSearchers.length;t<o;t+=1){let s=registeredSearchers[t];if(s.condition(c,e))return new s(c,e)}return new BitapSearch(c,e)}const LogicalOperator={AND:"$and",OR:"$or"},KeyType={PATH:"$path",PATTERN:"$val"},isExpression=c=>!!(c[LogicalOperator.AND]||c[LogicalOperator.OR]),isPath=c=>!!c[KeyType.PATH],isLeaf=c=>!isArray(c)&&isObject(c)&&!isExpression(c),convertToExplicit=c=>({[LogicalOperator.AND]:Object.keys(c).map(e=>({[e]:c[e]}))});function parse(c,e,{auto:t=!0}={}){const o=s=>{let r=Object.keys(s);const n=isPath(s);if(!n&&r.length>1&&!isExpression(s))return o(convertToExplicit(s));if(isLeaf(s)){const i=n?s[KeyType.PATH]:r[0],a=n?s[KeyType.PATTERN]:s[i];if(!isString(a))throw new Error(LOGICAL_SEARCH_INVALID_QUERY_FOR_KEY(i));const d={keyId:createKeyId(i),pattern:a};return t&&(d.searcher=createSearcher(a,e)),d}let l={children:[],operator:r[0]};return r.forEach(i=>{const a=s[i];isArray(a)&&a.forEach(d=>{l.children.push(o(d))})}),l};return isExpression(c)||(c=convertToExplicit(c)),o(c)}function computeScore(c,{ignoreFieldNorm:e=Config.ignoreFieldNorm}){c.forEach(t=>{let o=1;t.matches.forEach(({key:s,norm:r,score:n})=>{const l=s?s.weight:null;o*=Math.pow(n===0&&l?Number.EPSILON:n,(l||1)*(e?1:r))}),t.score=o})}function transformMatches(c,e){const t=c.matches;e.matches=[],isDefined(t)&&t.forEach(o=>{if(!isDefined(o.indices)||!o.indices.length)return;const{indices:s,value:r}=o;let n={indices:s,value:r};o.key&&(n.key=o.key.src),o.idx>-1&&(n.refIndex=o.idx),e.matches.push(n)})}function transformScore(c,e){e.score=c.score}function format(c,e,{includeMatches:t=Config.includeMatches,includeScore:o=Config.includeScore}={}){const s=[];return t&&s.push(transformMatches),o&&s.push(transformScore),c.map(r=>{const{idx:n}=r,l={item:e[n],refIndex:n};return s.length&&s.forEach(i=>{i(r,l)}),l})}class Fuse{constructor(e,t={},o){this.options={...Config,...t},this.options.useExtendedSearch,this._keyStore=new KeyStore(this.options.keys),this.setCollection(e,o)}setCollection(e,t){if(this._docs=e,t&&!(t instanceof FuseIndex))throw new Error(INCORRECT_INDEX_TYPE);this._myIndex=t||createIndex(this.options.keys,this._docs,{getFn:this.options.getFn,fieldNormWeight:this.options.fieldNormWeight})}add(e){isDefined(e)&&(this._docs.push(e),this._myIndex.add(e))}remove(e=()=>!1){const t=[];for(let o=0,s=this._docs.length;o<s;o+=1){const r=this._docs[o];e(r,o)&&(this.removeAt(o),o-=1,s-=1,t.push(r))}return t}removeAt(e){this._docs.splice(e,1),this._myIndex.removeAt(e)}getIndex(){return this._myIndex}search(e,{limit:t=-1}={}){const{includeMatches:o,includeScore:s,shouldSort:r,sortFn:n,ignoreFieldNorm:l}=this.options;let i=isString(e)?isString(this._docs[0])?this._searchStringList(e):this._searchObjectList(e):this._searchLogical(e);return computeScore(i,{ignoreFieldNorm:l}),r&&i.sort(n),isNumber(t)&&t>-1&&(i=i.slice(0,t)),format(i,this._docs,{includeMatches:o,includeScore:s})}_searchStringList(e){const t=createSearcher(e,this.options),{records:o}=this._myIndex,s=[];return o.forEach(({v:r,i:n,n:l})=>{if(!isDefined(r))return;const{isMatch:i,score:a,indices:d}=t.searchIn(r);i&&s.push({item:r,idx:n,matches:[{score:a,value:r,norm:l,indices:d}]})}),s}_searchLogical(e){const t=parse(e,this.options),o=(l,i,a)=>{if(!l.children){const{keyId:u,searcher:h}=l,p=this._findMatches({key:this._keyStore.get(u),value:this._myIndex.getValueForItemAtKeyId(i,u),searcher:h});return p&&p.length?[{idx:a,item:i,matches:p}]:[]}const d=[];for(let u=0,h=l.children.length;u<h;u+=1){const p=l.children[u],m=o(p,i,a);if(m.length)d.push(...m);else if(l.operator===LogicalOperator.AND)return[]}return d},s=this._myIndex.records,r={},n=[];return s.forEach(({$:l,i})=>{if(isDefined(l)){let a=o(t,l,i);a.length&&(r[i]||(r[i]={idx:i,item:l,matches:[]},n.push(r[i])),a.forEach(({matches:d})=>{r[i].matches.push(...d)}))}}),n}_searchObjectList(e){const t=createSearcher(e,this.options),{keys:o,records:s}=this._myIndex,r=[];return s.forEach(({$:n,i:l})=>{if(!isDefined(n))return;let i=[];o.forEach((a,d)=>{i.push(...this._findMatches({key:a,value:n[d],searcher:t}))}),i.length&&r.push({idx:l,item:n,matches:i})}),r}_findMatches({key:e,value:t,searcher:o}){if(!isDefined(t))return[];let s=[];if(isArray(t))t.forEach(({v:r,i:n,n:l})=>{if(!isDefined(r))return;const{isMatch:i,score:a,indices:d}=o.searchIn(r);i&&s.push({score:a,key:e,value:r,idx:n,norm:l,indices:d})});else{const{v:r,n}=t,{isMatch:l,score:i,indices:a}=o.searchIn(r);l&&s.push({score:i,key:e,value:r,norm:n,indices:a})}return s}}Fuse.version="7.1.0";Fuse.createIndex=createIndex;Fuse.parseIndex=parseIndex;Fuse.config=Config;Fuse.parseQuery=parse;register(ExtendedSearch);const FUSE_OPTIONS={keys:[{name:"OrderCode",weight:1},{name:"ProductName",weight:.8},{name:"Range",weight:.5},{name:"Group",weight:.5},{name:"SubGroup",weight:.5},{name:"Description",weight:.4},{name:"Finish",weight:.35},{name:"Colour",weight:.35},{name:"LongDescription",weight:.2}],threshold:.4,includeScore:!0,ignoreLocation:!0,minMatchCharLength:2};function normaliseProduct(c){return{...c,ProductName:c.ProductName||c["Product Name"]||"",LongDescription:c.LongDescription||c["Long Description"]||"",SubGroup:c.SubGroup||c.Subgroup||"",Colour:c.Colour||c.Color||"",Barcode:(c.BARCODE||c.Barcode||"").toString()}}class ProductSearch{constructor(e={}){this._getSynonyms=e.getSynonyms||(t=>[t]),this._products=[],this._normalised=[],this._fuse=null,this._codeIndex=new Map}buildIndex(e){this._products=e,this._normalised=e.map(normaliseProduct),this._fuse=new Fuse(this._normalised,FUSE_OPTIONS),this._codeIndex.clear();for(let t=0;t<e.length;t++){const o=e[t];o.OrderCode&&(this._codeIndex.set(o.OrderCode.toString().toLowerCase().trim(),t),this._codeIndex.set(o.OrderCode.toString().toLowerCase().trim().replace(/[-\s]/g,""),t));const s=(o.BARCODE||o.Barcode||"").toString().trim();s&&(this._codeIndex.set(s.toLowerCase(),t),this._codeIndex.set(s.toLowerCase().replace(/[-\s]/g,""),t))}}findByCode(e){if(!e)return null;const t=e.toString().toLowerCase().trim(),o=this._codeIndex.get(t)??this._codeIndex.get(t.replace(/[-\s]/g,""));return o!=null?this._products[o]:null}search(e,t=50,{fuzzy:o=!1}={}){return!e||e.length<2?[]:o?this._searchFuzzy(e,t):this._searchExact(e,t)}_searchExact(e,t){const o=e.toLowerCase().trim().split(/\s+/).filter(r=>r.length>=2);if(o.length===0)return[];const s=[];for(const r of this._normalised){const n=o.map(i=>this._scoreExact(r,i));if(n.some(i=>i===0))continue;const l=n.reduce((i,a)=>i+a,0)/n.length;s.push({product:r,score:l})}return s.sort((r,n)=>n.score-r.score),s.slice(0,t).map(r=>r.product)}_scoreExact(e,t){let o=0;const s=(e.OrderCode||"").toString().toLowerCase().trim(),r=(e.Barcode||"").toString().toLowerCase().trim(),n=(e.ProductName||"").toLowerCase().trim(),l=(e.Description||"").toLowerCase().trim(),i=(e.LongDescription||"").toLowerCase().trim(),a=(e.Range||"").toLowerCase().trim(),d=(e.Group||"").toLowerCase().trim(),u=(e.SubGroup||"").toLowerCase().trim(),h=(e.Finish||"").toLowerCase().trim(),p=(e.Colour||"").toLowerCase().trim(),m=/^\d+$/.test(t),f=this._getSynonyms(t);if(f.some(g=>g!==t)){const g=[n,l,d,u,a,i].join(" ");for(const w of f)if(g.includes(w)){o=Math.max(o,45);break}}return s===t||r===t?100:(s.includes(t)&&(o=Math.max(o,90)),!m&&r.includes(t)&&(o=Math.max(o,90)),n===t?o=Math.max(o,80):n.startsWith(t)?o=Math.max(o,70):n.includes(t)&&(o=Math.max(o,60)),(a.includes(t)||d.includes(t)||u.includes(t))&&(o=Math.max(o,50)),l.includes(t)&&(o=Math.max(o,40)),(h.includes(t)||p.includes(t))&&(o=Math.max(o,30)),i.includes(t)&&(o=Math.max(o,20)),o)}_searchFuzzy(e,t){if(!this._fuse)return[];const o=e.toLowerCase().trim().split(/\s+/).filter(n=>n.length>=2);if(o.length===0)return[];const s=new Map;for(const n of o){const l=this._getSynonyms(n);for(const i of l){const a=this._fuse.search(i);for(const d of a){const u=d.item.OrderCode;if(!u)continue;const h=s.get(u);(!h||d.score<h.score)&&s.set(u,{product:d.item,score:d.score,matchedTerms:new Set}),s.get(u).matchedTerms.add(n)}}}const r=[...s.values()];return r.sort((n,l)=>{const i=l.matchedTerms.size-n.matchedTerms.size;return i!==0?i:n.score-l.score}),r.slice(0,t).map(n=>n.product)}}const PDF_COLORS={headerBackground:"#8B6C2B",footerBackground:"#9B9184",textPrimary:"#222",textSecondary:"#444",textSubtle:"#666",linkColor:[0,102,204],white:"#fff",headerText:"#f4f4f4"},PDF_LAYOUT={margins:{left:32,right:32},footerHeight:28,maxRowsPerPage:4,rowPadding:8,imageWidth:90,imagePadding:12,welsColumnWidth:50,codeColumnOffset:85,coverLogoWidth:250},preloadedImageCache=new Map;function getCachedImage(c){return preloadedImageCache.get(c)}function hasWelsData(c){const e=c["WELS STAR"]||c.WELS_STAR||c.WELS_STAR||c.WelsStar||"";return e&&e.toString().trim()!==""}function calculateColumnLayout(c,e={}){const{leftMargin:t=PDF_LAYOUT.margins.left,rightMargin:o=PDF_LAYOUT.margins.right,showRrp:s=!1,showPrice:r=!0,showQty:n=!0,showTotal:l=!0}=e,i=PDF_LAYOUT.imageWidth,a=PDF_LAYOUT.imagePadding,d=PDF_LAYOUT.welsColumnWidth,u=t+i*2+a*2,h=u+PDF_LAYOUT.codeColumnOffset;let p,m,f;if(s&&r&&n&&l){const g=c-280,w=g-d,b=c-200,y=c-120,S=c-60;p=[t,u,h,w,g,b,y,S],m=[i,i,w-h-10,d,b-g,y-b,S-y,60],f=["Code","Description","WELS","RRP","Price","Qty","Total"]}else if(r&&n&&l){const g=c-200,w=g-d,b=c-120,y=c-60;p=[t,u,h,w,g,b,y],m=[i,i,w-h-10,d,b-g,y-b,60],f=["Code","Description","WELS","Price","Qty","Total"]}else if(r&&!n)if(s){const g=c-180,w=g-d,b=c-90;p=[t,u,h,w,g,b],m=[i,i,w-h-10,d,b-g,90],f=["Code","Description","WELS","RRP","Price"]}else{const g=c-90,w=g-d;p=[t,u,h,w,g],m=[i,i,w-h-10,d,90],f=["Code","Description","WELS","Price"]}else if(!r&&n){const g=c-80,w=g-d;p=[t,u,h,w,g],m=[i,i,w-h-10,d,80],f=["Code","Description","WELS","Qty"]}else{const g=c-o-d;p=[t,u,h,g],m=[i,i,g-h-10,d],f=["Code","Description","WELS"]}return{colX:p,colW:m,headers:f,imgW:i,imgPad:a}}function drawPDFHeader(c,e={}){const{pageWidth:t,colX:o,colW:s,leftMargin:r=PDF_LAYOUT.margins.left,footerHeight:n=PDF_LAYOUT.footerHeight,logoDataUrl:l,logoNaturalW:i,logoNaturalH:a,headers:d=[],userDetails:u={},skipWelsHeader:h=!1,headerColor:p=PDF_COLORS.headerBackground}=e,m=n+5.7;if(c.setFillColor(p),c.rect(0,0,t,m,"F"),l&&i&&a){const g=i/a,w=80,b=m*.6;let y=b*g,S=b;y>w&&(y=w,S=y/g);const v=(m-S)/2;c.addImage(l,"PNG",r,v,y,S)}c.setFontSize(10),c.setTextColor(PDF_COLORS.headerText),c.setFont("helvetica","normal");const f=m-8;d.forEach((g,w)=>{if(g==="WELS"&&h)return;const b=w+1;if(b<o.length){const y=o[b]+s[b]/2;if(g==="Price"&&!u.excludePrice){c.setFont("helvetica","normal");const S=u.includeGst?"INC GST":"EX GST",v=`Price ${S}`,E=c.getTextWidth("Price "),C=y-c.getTextWidth(v)/2;c.text("Price ",C,f),c.setFont("helvetica","bold"),c.text(S,C+E,f),c.setFont("helvetica","normal")}else if(g==="RRP"){const S=u.includeGst?"INC":"EX";c.text(`RRP ${S}`,y,f,{align:"center"})}else c.text(g,y,f,{align:"center"})}})}function drawPDFFooter(c,e={}){const{pageWidth:t,pageHeight:o,leftMargin:s=PDF_LAYOUT.margins.left,footerHeight:r=PDF_LAYOUT.footerHeight,pageNumber:n,totalPages:l,footerColor:i=PDF_COLORS.footerBackground}=e;c.setFillColor(i),c.rect(0,o-r,t,r,"F"),c.setTextColor(PDF_COLORS.white),c.setFontSize(11);const a=o-r/2+3;c.text("www.seima.com.au",t-140,a),n!==void 0&&l!==void 0&&c.text(`Page ${n} of ${l}`,s,a)}function drawCoverPage(c,e={}){const{pageWidth:t,pageHeight:o,seimaLogoDataUrl:s,seimaLogoNaturalW:r,seimaLogoNaturalH:n,customerLogoDataUrl:l,userDetails:i={},staffContact:a,footerHeight:d=PDF_LAYOUT.footerHeight}=e,u=t/2,h=320,p=90,m=(t-h)/2,f=70;if(l){c.setFillColor(255,255,255),c.rect(m,f,h,p,"F");try{const I=new Image;I.src=l;const _=h-20,D=p-20,j=I.width/I.height||2;let z=_,$=_/j;$>D&&($=D,z=D*j);const G=m+(h-z)/2,q=f+(p-$)/2;c.addImage(l,"PNG",G,q,z,$,void 0,"FAST")}catch(I){console.warn("Failed to draw customer logo:",I)}}const g=PDF_LAYOUT.coverLogoWidth,w=n&&r?g*n/r:65,b=(t-g)/2,y=f+p+80;s&&c.addImage(s,"PNG",b,y,g,w,void 0,"FAST");const S="Build with Confidence",v=y+w+28;c.setFont("helvetica","normal"),c.setFontSize(18),c.setTextColor("#333");const E=S.split(""),C=c.getTextWidth(S),L=(g-C)/(E.length-1);let A=b;E.forEach(I=>{c.text(I,A,v),A+=c.getTextWidth(I)+L}),c.setFontSize(15),c.setTextColor(PDF_COLORS.textSecondary);const T=u;let k=v+50;const B=[];i!=null&&i.name&&i.name.trim()&&B.push({label:"Name:",value:i.name.trim(),bold:!0}),i!=null&&i.project&&i.project.trim()&&B.push({label:"Project:",value:i.project.trim(),bold:!0}),i!=null&&i.address&&i.address.trim()&&B.push({label:"Address:",value:i.address.trim(),bold:!0}),i!=null&&i.email&&i.email.trim()&&B.push({label:"Email:",value:i.email.trim(),bold:!0});const x=(i==null?void 0:i.telephone)||(i==null?void 0:i.phone)||"";x&&x.trim()&&B.push({label:"Telephone:",value:x.trim(),bold:!0});const P=B.length*26,R=o-d-40-k;P<R&&(k=k+(R-P)/3),B.forEach(I=>{c.setFont("helvetica","normal"),c.setFontSize(15),c.setTextColor(PDF_COLORS.textSecondary);const _=c.getTextWidth(I.label+" ");c.text(I.label,T-80,k),I.bold&&c.setFont("helvetica","bold"),c.text(I.value,T-80+_,k),k+=26});let F="";const O=(a==null?void 0:a.name)||(a==null?void 0:a.staffName)||"",H=(a==null?void 0:a.phone)||(a==null?void 0:a.mobile)||(a==null?void 0:a.staffPhone)||"",N=(a==null?void 0:a.email)||(a==null?void 0:a.staffEmail)||"",U=(a==null?void 0:a.position)||(a==null?void 0:a.staffPosition)||"";O&&H&&N?F=`For more information, please contact ${U?`${O}, ${U}`:O} on ${H} or email ${N}`:O&&N?F=`For more information, please contact ${U?`${O}, ${U}`:O} at ${N}`:O?F=`For more information, please contact ${U?`${O}, ${U}`:O}`:H?F=`For more information, please call ${H}`:N&&(F=`For more information, please email ${N}`),F||(F="For more information, please contact your Seima representative or email info@seima.com.au"),c.setFont("helvetica","normal"),c.setFontSize(14),c.setTextColor("#111"),c.text(F,u,o-d-18,{align:"center"}),drawPDFFooter(c,{pageWidth:t,pageHeight:o,footerHeight:d})}function drawRoomHeader(c,e,t,o,s){c.setFontSize(12),c.setFont("helvetica","bold"),c.setTextColor("#333"),c.text(`${e} (${t})`,o,s+10),c.setFont("helvetica","normal")}function drawProductLinks(c,e,t,o){let s=o;if(e.Datasheet_URL&&e.Datasheet_URL!=="#"&&e.Datasheet_URL.startsWith("http")){c.setFontSize(9),c.setTextColor(...PDF_COLORS.linkColor),c.textWithLink("Datasheet",t,s,{url:e.Datasheet_URL,align:"center"});const r=c.getTextWidth("Datasheet");c.setDrawColor(...PDF_COLORS.linkColor),c.setLineWidth(.3),c.line(t-r/2,s+1.5,t+r/2,s+1.5),s+=16}if(e.Website_URL&&e.Website_URL!=="#"&&e.Website_URL.startsWith("http")){c.setFontSize(9),c.setTextColor(...PDF_COLORS.linkColor),c.textWithLink("Website",t,s,{url:e.Website_URL,align:"center"});const r=c.getTextWidth("Website");c.setDrawColor(...PDF_COLORS.linkColor),c.setLineWidth(.3),c.line(t-r/2,s+1.5,t+r/2,s+1.5),s+=16}return s}function drawProductDescription(c,e,t,o,s,r=!1){let n=o;c.setFontSize(10),c.setTextColor(PDF_COLORS.textPrimary);const l=c.splitTextToSize(String(e.Description||""),s);c.text(l,t+5,n),n+=l.length*12;const i=e.LongDescription||e["Long Description"]||e.longDescription||"";if(!r&&i){c.setFontSize(9),c.setTextColor(PDF_COLORS.textSecondary);const a=c.splitTextToSize(String(i),s);c.text(a,t+5,n),n+=a.length*11}if(e.Notes){c.setFont("helvetica","italic"),c.setFontSize(9),c.setTextColor(PDF_COLORS.textSecondary);const a=c.splitTextToSize("Notes: "+String(e.Notes),s);c.text(a,t+5,n),c.setFont("helvetica","normal"),n+=a.length*11}return n}function drawWelsRating(c,e,t,o){const s=e["WELS STAR"]||e.WELS_STAR||e.WELS_STAR||e.WelsStar||"";if(s&&s.toString().trim()){const r=s.toString().replace(/[^\d.]/g,"").trim();r&&(c.setFontSize(9),c.setTextColor(PDF_COLORS.textSubtle),c.text(`${r} star`,t,o,{align:"center"}))}}function formatPrice(c){return!c||isNaN(c)||c<=0?"":"$"+c.toFixed(2).replace(/\B(?=(\d{3})+(?!\d))/g,",")}function drawProductPricing(c,e,t,o,s,r,n={}){const{excludePrice:l=!1,includeGst:i=!1}=n;c.setFontSize(10),c.setTextColor(PDF_COLORS.textPrimary);const a=s.indexOf("RRP")+1;if(a>0&&t[a]){let m=NaN;const f=e.RRP_EX||e["RRP EX GST"]||e.RRP_EX||e.RRP_EXGST;f&&(m=parseFloat(f.toString().replace(/,/g,"")),i&&!isNaN(m)&&(m*=1.1));const g=formatPrice(m);if(g){const w=t[a]+o[a]/2;c.text(g,w,r,{align:"center"})}}const d=s.indexOf("Price")+1;let u=NaN;if(d>0&&t[d]){if(e.UserEditedPrice!==void 0&&e.UserEditedPrice!==null&&e.UserEditedPrice!=="")u=parseFloat(e.UserEditedPrice.toString().replace(/,/g,""));else{const f=e.RRP_EX||e["RRP EX GST"]||e.RRP_EX||e.RRP_EXGST;f&&(u=parseFloat(f.toString().replace(/,/g,"")))}i&&!isNaN(u)&&(u*=1.1);const m=formatPrice(u);if(m){const f=t[d]+o[d]/2;c.text(m,f,r,{align:"center"})}}const h=s.indexOf("Qty")+1;if(h>0&&t[h]){const m=t[h]+o[h]/2;c.text(String(e.Quantity||1),m,r,{align:"center"})}const p=s.indexOf("Total")+1;if(p>0&&t[p]){const m=(isNaN(u)?0:u)*(e.Quantity||1),f=formatPrice(m);if(f){const g=t[p]+o[p]/2;c.text(f,g,r,{align:"center"})}}}class DataService{constructor(){this.storageKeys={LEGACY_SELECTION:"selection",PRODUCTS:CONFIG.STORAGE_KEYS.SELECTED_PRODUCTS,CATALOG:CONFIG.STORAGE_KEYS.PRODUCT_CATALOG,CUSTOM_ROOMS:CONFIG.STORAGE_KEYS.CUSTOM_ROOMS,STAFF_CONTACT:CONFIG.STORAGE_KEYS.STAFF_CONTACT},this.productCatalog=[],this.isLoaded=!1,this._productSearch=new ProductSearch}async init(){try{return console.log("🔄 Initializing DataService..."),await this.loadProductCatalog(),this._productSearch.buildIndex(this.productCatalog),this.isLoaded=!0,console.log(`✅ DataService initialized with ${this.productCatalog.length} products`),!0}catch(e){throw console.error("❌ DataService initialization failed:",e),this.isLoaded=!1,e}}async loadProductCatalog(){try{let e=localStorage.getItem("productCatalogCsv"),t=[];e&&(t=this.parseCSV(e),this.productCatalog=t,console.log(`📦 Loaded ${t.length} products from cache`));const o=CONFIG.CATALOG_URL+(CONFIG.CATALOG_URL.includes("?")?"&":"?")+"t="+Date.now();if(fetch(o).then(s=>s.ok?s.text():Promise.reject("Failed to fetch catalog")).then(s=>{if(!e||s!==e){localStorage.setItem("productCatalogCsv",s);const r=this.parseCSV(s);JSON.stringify(r)!==JSON.stringify(t)&&(this.productCatalog=r,window.location.reload())}}).catch(s=>console.warn("Background catalog update failed:",s)),!t.length)throw new Error("No product data available");return t}catch(e){throw console.error("❌ Failed to load product catalog:",e),this.productCatalog=[],e}}parseCSV(e){const t=this.parseCSVRows(e);if(t.length===0)return[];const o=t[0].map(n=>n.replace(/[\r\n]+\s*/g," ").trim()),s=o.findIndex(n=>n==="OrderCode"||n==="Order Code");if(s===-1)return[];const r=[];for(let n=1;n<t.length;n++){const l=t[n];if(l.length<=s)continue;const i=l[s]?l[s].trim():"";if(!i)continue;const a={};o.forEach((d,u)=>{a[d]=l[u]||""}),a.OrderCode=i,a["Product Name"]=a["Product Name"]||a["Parent Code"]||"",a.Description=a.Description||"",a.LongDescription=a["Long Description"]||a.LongDescription||"",a.RRP_EXGST=a["RRP EX GST"]||a.RRP_EXGST||"",a.RRP_INCGST=a["RRP INC GST"]||a.RRP_INCGST||"",a.BARCODE=(a.BARCODE||"").toString().trim(),a["WELS NO"]=a["WELS NO"]||"",a["WELS STAR"]=a["WELS STAR"]||"",a["WELS CONSUMPTION"]=a["WELS CONSUMPTION"]||"",a["WELS Expiry"]=a["WELS Expiry"]||"",r.push(a)}return r}parseCSVRows(e){const t=[];let o=[],s="",r=!1;for(let n=0;n<e.length;n++){const l=e[n],i=e[n+1];l==='"'?r&&i==='"'?(s+='"',n++):r=!r:l===","&&!r?(o.push(s),s=""):(l==="\r"||l===`
`)&&!r?(l==="\r"&&i===`
`&&n++,o.push(s),o.length>0&&o.some(a=>a.trim())&&t.push(o),o=[],s=""):s+=l}return(s||o.length>0)&&(o.push(s),o.some(n=>n.trim())&&t.push(o)),t}parseCSVLine(e){const t=[];let o="",s=!1;for(let r=0;r<e.length;r++){const n=e[r];n==='"'?s=!s:n===","&&!s?(t.push(o.trim()),o=""):o+=n}return t.push(o.trim()),t}getAllProducts(){return this.productCatalog}searchProducts(e,t=50){return this._productSearch.search(e,t,{fuzzy:!1})}findProductByCode(e){if(!e)return null;const t=e.toString().trim();return this.productCatalog.find(o=>(o.OrderCode||o.orderCode||"").toString().trim()===t)}findProductByBarcode(e){if(!e)return null;const t=e.toString().trim();return this.productCatalog.find(o=>o.BARCODE&&o.BARCODE.toString().trim()===t)||null}getSelectedProducts(){try{const e=JSON.parse(localStorage.getItem(this.storageKeys.PRODUCTS)||"[]");if(e.length>0)return this._validateSelectionFormat(e);const t=JSON.parse(localStorage.getItem(this.storageKeys.LEGACY_SELECTION)||"[]");return this._convertLegacyFormat(t)}catch(e){return console.error("Error loading selected products:",e),[]}}addProduct(e,t="",o="",s=1){if(!this._validateProduct(e))throw new Error("Invalid product data");const r=this.getSelectedProducts(),n={id:Utils.generateId(),product:Utils.deepClone(e),notes:Utils.sanitizeInput(t,CONFIG.UI.ANNOTATION_MAX_LENGTH),room:Utils.sanitizeInput(o,50),quantity:Math.max(1,Math.min(999,parseInt(s)||1)),timestamp:Date.now()};return r.push(n),this._saveSelectedProducts(r),console.log(`✅ Added ${e.OrderCode||"product"} to selection`),n}removeProduct(e){const o=this.getSelectedProducts().filter(s=>s.id!==e);return this._saveSelectedProducts(o),console.log("✅ Removed product from selection"),o}updateProduct(e,t){const o=this.getSelectedProducts(),s=o.findIndex(n=>n.id===e);if(s===-1)throw new Error("Product not found in selection");const r=o[s];return o[s]={...r,...t,id:e,timestamp:r.timestamp,notes:t.notes?Utils.sanitizeInput(t.notes,CONFIG.UI.ANNOTATION_MAX_LENGTH):r.notes,room:t.room?Utils.sanitizeInput(t.room,50):r.room,quantity:t.quantity?Math.max(1,Math.min(999,parseInt(t.quantity)||1)):r.quantity},this._saveSelectedProducts(o),console.log("✅ Updated product in selection"),o[s]}clearSelection(){localStorage.removeItem(this.storageKeys.PRODUCTS),localStorage.removeItem(this.storageKeys.LEGACY_SELECTION),console.log("✅ Cleared all selected products")}getProductsByRoom(){const e=this.getSelectedProducts(),t={};return e.forEach(o=>{const s=o.room||"Unassigned";t[s]||(t[s]=[]),t[s].push(o)}),t}getSelectionStats(){const e=this.getSelectedProducts(),t=this.getProductsByRoom();return{totalProducts:e.length,totalRooms:Object.keys(t).length,roomBreakdown:Object.entries(t).map(([o,s])=>({room:o,count:s.length}))}}getProductsLegacyFormat(){return this.getSelectedProducts().map(t=>({...t.product,Room:t.room,Notes:t.notes,Quantity:t.quantity,Timestamp:new Date(t.timestamp).toISOString()}))}getStaffContact(){try{const e=localStorage.getItem(this.storageKeys.STAFF_CONTACT);return e?JSON.parse(e):null}catch(e){return console.warn("Error loading staff contact:",e),null}}setStaffContact(e){try{localStorage.setItem(this.storageKeys.STAFF_CONTACT,JSON.stringify(e)),console.log("✅ Staff contact saved")}catch(t){throw console.error("Error saving staff contact:",t),t}}getCustomRooms(){try{return JSON.parse(localStorage.getItem(this.storageKeys.CUSTOM_ROOMS)||"[]")}catch(e){return console.warn("Error loading custom rooms:",e),[]}}addCustomRoom(e){const t=this.getCustomRooms();t.find(o=>o.name===e)||(t.push({name:e,timestamp:Date.now()}),localStorage.setItem(this.storageKeys.CUSTOM_ROOMS,JSON.stringify(t)),console.log(`✅ Added custom room: ${e}`))}removeCustomRoom(e){const o=this.getCustomRooms().filter(s=>s.name!==e);localStorage.setItem(this.storageKeys.CUSTOM_ROOMS,JSON.stringify(o)),console.log(`✅ Removed custom room: ${e}`)}getProductCatalog(){try{const e=localStorage.getItem(this.storageKeys.CATALOG);return e?JSON.parse(e):[]}catch(e){return console.warn("Error loading product catalog from storage:",e),[]}}setProductCatalog(e){try{localStorage.setItem(this.storageKeys.CATALOG,JSON.stringify(e)),console.log(`✅ Cached ${e.length} products to storage`)}catch(t){console.warn("Error caching product catalog:",t)}}_convertLegacyFormat(e){return Array.isArray(e)?e.map(t=>({id:Utils.generateId(),product:{...t},room:t.Room||"",notes:t.Notes||"",quantity:t.Quantity||1,timestamp:t.Timestamp?new Date(t.Timestamp).getTime():Date.now()})):[]}_validateSelectionFormat(e){return Array.isArray(e)?e.filter(t=>t&&typeof t=="object"&&t.product&&typeof t.product=="object"):[]}_validateProduct(e){return e&&typeof e=="object"&&(e.OrderCode||e.Description)}_saveSelectedProducts(e){try{localStorage.setItem(this.storageKeys.PRODUCTS,JSON.stringify(e)),localStorage.removeItem(this.storageKeys.LEGACY_SELECTION)}catch(t){throw console.error("Error saving selected products:",t),t}}migrateLegacyData(){const e=JSON.parse(localStorage.getItem(this.storageKeys.LEGACY_SELECTION)||"[]"),t=JSON.parse(localStorage.getItem(this.storageKeys.PRODUCTS)||"[]");if(e.length>0&&t.length===0){console.log("📦 Migrating legacy selection data...");const o=this._convertLegacyFormat(e);return this._saveSelectedProducts(o),console.log(`✅ Migrated ${o.length} products to new format`),!0}return!1}}const dataService=new DataService;class SelectionRecorder{constructor(){var e,t,o,s;this.isEnabled=(e=CONFIG.SELECTION_RECORDING)==null?void 0:e.ENABLED,this.googleSheetsUrl=((t=CONFIG.SELECTION_RECORDING)==null?void 0:t.GOOGLE_SHEETS_URL)||null,this.retryAttempts=(o=CONFIG.SELECTION_RECORDING)==null?void 0:o.RETRY_ATTEMPTS,this.retryDelay=(s=CONFIG.SELECTION_RECORDING)==null?void 0:s.RETRY_DELAY}configure(e){this.googleSheetsUrl=e,console.log("📊 Selection recorder configured with Google Sheets URL")}async recordSelection(e,t,o={}){if(!this.isEnabled||!this.googleSheetsUrl)return console.log("📊 Selection recording disabled or not configured"),{success:!1,reason:"not_configured"};try{const s=this.prepareSelectionData(e,t,o),r=await this.sendToGoogleSheets(s);if(r.success)return console.log("✅ Selection recorded successfully"),{success:!0,data:s};throw new Error(r.error||"Failed to record selection")}catch(s){return console.error("❌ Failed to record selection:",s),{success:!1,error:s.message}}}prepareSelectionData(e,t,o){const s=new Date,r=e.staffContact||{},n=authService.getCurrentUser(),l=authService.isLoggedIn();let i,a,d;l?(i=r.name||(n==null?void 0:n.name)||"",a=r.email||(n==null?void 0:n.email)||"",d=r.mobile||(n==null?void 0:n.phone)||""):(i="Self-Service",a="",d="");const u=(n==null?void 0:n.email)||"",h=t.length,p=t.reduce((b,y)=>b+(y.quantity||1),0),m=this.calculateEstimatedValue(t),f=[...new Set(t.map(b=>b.room).filter(Boolean))],g=e.leadData||{};return{date:s.toLocaleDateString("en-AU"),time:s.toLocaleTimeString("en-AU"),appVersion:CONFIG.VERSION,loggedInAs:u,staffName:i,staffEmail:a,staffMobile:this.formatPhoneNumber(d),customerName:e.name||"",customerEmail:e.email||"",customerPhone:this.formatPhoneNumber(e.phone),customerProject:e.project||"",customerAddress:e.address||"",customerType:g.customerType||"",hearAboutUs:this.formatHearAboutUs(g),projectNotes:g.projectNotes||"",builderName:g.builderName||"",merchantName:g.merchantName||"",referralBuilder:g.referralBuilder||"",referralMerchant:g.referralMerchant||"",totalProducts:h,totalQuantity:p,totalRooms:f.length,roomsList:f.join(", "),estimatedValue:m,emailSent:o.success||!1,pdfGenerated:o.pdfGenerated||!1,csvGenerated:o.csvGenerated||!1,pdfSize:o.pdfSize||"",productsJson:JSON.stringify(t.map(b=>{var y,S,v,E,C,M;return{orderCode:((y=b.product)==null?void 0:y.OrderCode)||((S=b.product)==null?void 0:S.orderCode)||"",description:((v=b.product)==null?void 0:v.Description)||((E=b.product)==null?void 0:E.description)||"",room:b.room||"",quantity:b.quantity||1,notes:b.notes||"",priceIncGst:((C=b.product)==null?void 0:C.RRP_INCGST)||((M=b.product)==null?void 0:M.rrpIncGst)||"0.00"}}))}}formatHearAboutUs(e){if(!e||!e.hearAboutUs)return"";if(Array.isArray(e.hearAboutUs)){let t=[...e.hearAboutUs];if(t.includes("Other")&&e.hearAboutUsOther){const o=t.indexOf("Other");t[o]=`Other (${e.hearAboutUsOther})`}return t.join(", ")}return e.hearAboutUs||""}calculateEstimatedValue(e){let t=0;return e.forEach(o=>{var l,i;const s=o.quantity||1,r=((l=o.product)==null?void 0:l.RRP_INCGST)||((i=o.product)==null?void 0:i.rrpIncGst)||"0",n=parseFloat(r.toString().replace(/[^0-9.]/g,""))||0;t+=n*s}),t.toFixed(2)}formatPhoneNumber(e){if(!e)return"";let t=String(e).trim();return t.startsWith("'")&&(t=t.substring(1)),/^4\d{8}$/.test(t)&&(t="0"+t),"'"+t}async sendToGoogleSheets(e,t=1){try{const o=new URLSearchParams;o.append("data",JSON.stringify(e));const s=await fetch(this.googleSheetsUrl,{method:"POST",headers:{"Content-Type":"application/x-www-form-urlencoded"},body:o});if(!s.ok)throw new Error(`HTTP ${s.status}: ${s.statusText}`);return{success:!0,result:await s.json()}}catch(o){return console.error(`📊 Attempt ${t} failed:`,o),t<this.retryAttempts?(console.log(`📊 Retrying in ${this.retryDelay}ms... (attempt ${t+1}/${this.retryAttempts})`),await new Promise(s=>setTimeout(s,this.retryDelay)),this.sendToGoogleSheets(e,t+1)):{success:!1,error:o.message}}}async testConnection(){if(!this.googleSheetsUrl)return{success:!1,error:"No Google Sheets URL configured"};const e={date:new Date().toLocaleDateString("en-AU"),time:new Date().toLocaleTimeString("en-AU"),staffName:"Test User",customerName:"Test Customer",totalProducts:1,test:!0};return await this.sendToGoogleSheets(e)}setEnabled(e){this.isEnabled=e,console.log(`📊 Selection recording ${e?"enabled":"disabled"}`)}}const selectionRecorder=new SelectionRecorder;class EmailTemplateGenerator{constructor(){this.brandColors={primary:"#a09484",primaryDark:"#8b7a6e",background:"#f8f8fa",cardBackground:"#ffffff",textPrimary:"#222",textSecondary:"#4b5563",textMuted:"#6b7280",success:"#10b981",warning:"#f59e0b",border:"#e5e7eb"}}generateEmailHTML(e,t={}){const{includeLogo:o=!0,includeAttachmentInfo:s=!1,includeFeaturesList:r=!1,customMessage:n=null,theme:l="default"}=t,i=this.prepareEmailData(e);return`
      <!DOCTYPE html>
      <html>
      <head>
          <meta charset="utf-8">
...
© 2024 Seima | Generated by Seima Scanner v${t.appVersion}`}getProductCount(){return JSON.parse(localStorage.getItem("selectedProducts")||"[]").length}getRoomCount(){const e=JSON.parse(localStorage.getItem("selectedProducts")||"[]");return new Set(e.map(o=>o.room).filter(Boolean)).size||1}generateFileName(e,t){const o=new Date,s=String(o.getDate()).padStart(2,"0"),r=String(o.getMonth()+1).padStart(2,"0"),n=String(o.getFullYear()).slice(-2),l=String(o.getHours()).padStart(2,"0"),i=String(o.getMinutes()).padStart(2,"0");return`${(e.project||"seima-selection").replace(/[^a-zA-Z0-9\s]/g,"")}-${s}${r}${n}.${l}${i}.${t}`}}function testCleanedUpTemplate(){console.log("🧪 Testing cleaned up email template...");const c={name:"cleaned",email:"jsegredos@gmail.com",project:"cleaned",address:"Seima Pty Ltd",phone:"0418486702"};try{const t=new EmailTemplateGenerator().generateEmailHTML(c),o=window.open("","_blank","width=800,height=600");return o.document.write(t),o.document.close(),console.log("✅ Cleaned up email template preview opened in new window"),console.log("🎨 Changes applied:"),console.log("   • Header: Removed house icon and subtitle, changed to gold/brown background"),console.log('   • Sections: Removed "Attached Documents" and "Your selection includes" sections'),console.log("   • Footer: Removed top two lines"),!0}catch(e){return console.error("❌ Template test failed:",e),!1}}window.testCleanedUpTemplate=testCleanedUpTemplate;class EmailService{constructor(){this.providers={emailjs:new EmailJSProvider,seimaEmail:new SeimaEmailProvider},this.currentProvider=null,this.isInitialized=!1,this.templateGenerator=new EmailTemplateGenerator}async init(e="emailjs",t=null){try{const o=this.providers[e];if(!o)throw new Error(`Unknown email provider: ${e}`);const s=t||this._getProviderConfig(e);return await o.init(s),this.currentProvider=o,this.isInitialized=!0,console.log(`✅ Email service initialized with ${e}`),!0}catch(o){return console.error(`❌ Failed to initialize email service with ${e}:`,o),!1}}async sendEmail(e,t,o=null){if(!this.isInitialized||!this.currentProvider)throw new Error("Email service not initialized");try{const s=dataService.getStaffContact(),r={...e,staffContact:s},n=this._generateEmailContent(r,t,o);console.log("📧 Attempting email send (no size restrictions)...");const l=await this.currentProvider.sendEmail(n);if(l.success)return console.log("✅ Email sent successfully!"),this.recordSelection(r,t,o,l),l;throw new Error(l.error||"Email sending failed")}catch(s){return console.error("📧 Email sending failed, using fallback:",s),this._handleEmailFailure(e,t,o,s)}}async sendNotificationEmail(e){if(!this.isInitialized||!this.currentProvider)throw new Error("Email service not initialized");try{const t=dataService.getStaffContact(),o={...e,staffContact:t},s=this._generateEmailContent(o,null,null),r=await this.currentProvider.sendEmail(s);if(r.success)return this._showSuccess("✅ Notification email sent successfully!"),r;throw new Error(r.error||"Notification email failed")}catch(t){return console.error("📧 Notification email failed:",t),{success:!1,error:t.message}}}async testEmail(e=null){const t=e||{name:"Test User",email:"test@example.com",project:"Test Project",address:"Test Address",phone:"Test Phone"},o=`%PDF-1.4
Test PDF Content
%%EOF`,s=new Blob([o],{type:"application/pdf"}),r=`Code,Description,Quantity
TEST001,"Test Product",1`;return console.log("🧪 Testing email service..."),await this.sendEmail(t,s,r)}_generateEmailContent(e,t,o){var s;return{to:e.email,toName:e.name||e.email,from:CONFIG.EMAIL.FROM_EMAIL||"noreply@seima.com.au",fromName:"Seima Team",subject:`Seima Product Selection - ${e.name||"Customer"}`,html:this.templateGenerator.generateEmailHTML(e),text:this.templateGenerator.generateTextEmail(e),bcc:((s=e.staffContact)==null?void 0:s.email)||null,attachments:this._prepareAttachments(e,t,o)}}_prepareAttachments(e,t,o){const s=[];return t&&s.push({filename:this._generateFileName(e,"pdf"),content:t,type:"application/pdf"}),o&&s.push({filename:this._generateFileName(e,"csv"),content:new Blob([o],{type:"text/csv;charset=utf-8"}),type:"text/csv"}),s}_generateFileName(e,t){const o=new Date,s=`${String(o.getDate()).padStart(2,"0")}${String(o.getMonth()+1).padStart(2,"0")}${String(o.getFullYear()).slice(-2)}`,r=`${String(o.getHours()).padStart(2,"0")}${String(o.getMinutes()).padStart(2,"0")}`;return`${(e.project||"Selection").replace(/[^a-zA-Z0-9\s]/g,"")}-${s}.${r}.${t}`}_handleEmailFailure(e,t,o,s){console.error("📧 Email failed, providing download fallback:",s);const r=[];try{if(t){const n=this._generateFileName(e,"pdf");this._downloadFile(t,n),r.push("PDF"),console.log("✅ PDF downloaded as fallback")}}catch(n){console.error("❌ Failed to download PDF:",n)}try{if(o){const n=new Blob([o],{type:"text/csv;charset=utf-8"}),l=this._generateFileName(e,"csv");this._downloadFile(n,l),r.push("CSV"),console.log("✅ CSV downloaded as fallback")}}catch(n){console.error("❌ Failed to download CSV:",n)}return r.length>0?this._showError("Unable to send email. Files have been downloaded to your device."):this._showError("Email sending failed and file download failed. Please try again."),{success:!1,method:"download_fallback",error:s.message,downloadedFiles:r}}_downloadFile(e,t){const o=URL.createObjectURL(e),s=document.createElement("a");s.style.display="none",s.href=o,s.download=t,document.body.appendChild(s),s.click(),document.body.removeChild(s),URL.revokeObjectURL(o)}_getProviderConfig(e){switch(e){case"emailjs":return{publicKey:CONFIG.EMAIL.PUBLIC_KEY,serviceId:CONFIG.EMAIL.SERVICE_ID,templateId:CONFIG.EMAIL.TEMPLATE_ID};case"seimaEmail":return{apiUrl:CONFIG.EMAIL.SEIMA_EMAIL_API_URL,apiKey:CONFIG.EMAIL.SEIMA_EMAIL_API_KEY||null,fromEmail:CONFIG.EMAIL.FROM_EMAIL,fromName:CONFIG.EMAIL.FROM_NAME};default:return{}}}_showSuccess(e){window.showSuccessMessage?window.showSuccessMessage(e):console.log(e)}_showError(e){window.showErrorMessage?window.showErrorMessage(e):console.error(e)}async recordSelection(e,t,o,s){try{const r=this.getSelectedProducts();if(r.length===0){console.log("📊 No products to record");return}const n={success:!0,pdfGenerated:!!t,csvGenerated:!!o,pdfSize:t?`${(t.size/1024/1024).toFixed(2)}MB`:"",method:s.provider||"email"},l={...e};e.leadData?l.leadData=e.leadData:window.currentLeadData&&(l.leadData=window.currentLeadData);const i=await selectionRecorder.recordSelection(l,r,n);i.success?console.log("📊 Selection recorded successfully"):console.warn("📊 Selection recording failed:",i.error||i.reason)}catch(r){console.error("📊 Error recording selection:",r)}}getSelectedProducts(){try{const e=JSON.parse(localStorage.getItem(CONFIG.STORAGE_KEYS.SELECTED_PRODUCTS)||"[]");return e.length>0?e:JSON.parse(localStorage.getItem("selection")||"[]").map(o=>({product:o,room:o.Room||"",notes:o.Notes||"",quantity:o.Quantity||1}))}catch(e){return console.error("Error getting selected products:",e),[]}}}class SeimaEmailProvider{constructor(){this.isInitialized=!1,this.config=null,this.MAX_ATTACHMENT_BYTES=3*1024*1024}async init(e){if(!e||!e.apiUrl)throw new Error("Seima Email requires SEIMA_EMAIL_API_URL in CONFIG.EMAIL");this.config=e,this.isInitialized=!0,console.log("✅ Seima Email provider initialized")}async _blobToBase64(e){return new Promise((t,o)=>{const s=new FileReader;s.onloadend=()=>{const r=s.result.split(",")[1];t(r||"")},s.onerror=()=>o(s.error),s.readAsDataURL(e)})}async sendEmail(e){if(!this.isInitialized||!this.config)return{success:!1,provider:"seimaEmail",error:"Seima Email provider not initialized"};try{const t=[];for(const l of e.attachments||[]){const i=l.content instanceof Blob?l.content:new Blob([l.content]);if(i.size>this.MAX_ATTACHMENT_BYTES)return{success:!1,provider:"seimaEmail",error:`Attachment "${l.filename}" exceeds 3 MB limit. Use EmailJS or download instead.`};const a=await this._blobToBase64(i);t.push({filename:l.filename,contentType:l.type||"application/octet-stream",contentBase64:a})}const o={"Content-Type":"application/json"};this.config.apiKey&&(o["X-Api-Key"]=this.config.apiKey);const s=await fetch(this.config.apiUrl,{method:"POST",headers:o,body:JSON.stringify({to:e.to,toName:e.toName,subject:e.subject,html:e.html,text:e.text,bcc:e.bcc||null,fromName:this.config.fromName,attachments:t})}),r=await s.json().catch(()=>({}));if(s.ok&&(s.status===200||s.status===202))return{success:!0,provider:"seimaEmail",result:r};const n=r.details||r.error||`Request failed ${s.status}`;return console.warn("📧 Seima Email worker error:",s.status,r),{success:!1,provider:"seimaEmail",error:n}}catch(t){return{success:!1,provider:"seimaEmail",error:t.message||String(t)}}}}class EmailJSProvider{constructor(){this.isInitialized=!1}async init(e){window.emailjs||await this._loadEmailJS(),emailjs.init({publicKey:e.publicKey}),this.config=e,this.isInitialized=!0,console.log("✅ EmailJS provider initialized")}async sendEmail(e){try{const t={to_email:e.to,from_name:e.fromName,subject:e.subject,email_html:e.html,message_text:e.text,bcc_email:e.bcc||""};for(const s of e.attachments)s.type==="application/pdf"?(t.pdf_attachment=await this._blobToBase64(s.content),t.pdf_filename=s.filename):(s.type==="text/plain"||s.type==="text/csv")&&(t.csv_attachment=await this._blobToBase64(s.content),t.csv_filename=s.filename);const o=await emailjs.send(this.config.serviceId,this.config.templateId,t,this.config.publicKey);if(o.status===200)return{success:!0,provider:"emailjs",result:o};throw new Error(`EmailJS returned status ${o.status}`)}catch(t){return{success:!1,provider:"emailjs",error:t.message}}}async _loadEmailJS(){return new Promise((e,t)=>{const o=document.createElement("script");o.src="https://cdn.jsdelivr.net/npm/@emailjs/browser@3/dist/email.min.js",o.onload=e,o.onerror=t,document.head.appendChild(o)})}async _blobToBase64(e){return new Promise((t,o)=>{const s=new FileReader;s.onloadend=()=>{try{const r=s.result.split(",")[1];t(r)}catch(r){console.error("❌ Base64 conversion failed:",r),o(r)}},s.onerror=()=>{console.error("❌ FileReader error:",s.error),o(s.error)},s.readAsDataURL(e)})}}const emailService=new EmailService;function testEmailTemplate(){const c={name:"45",email:"jsegredos@gmail.com",project:"345",address:"house address",mobile:"55432"},t=new EmailTemplateGenerator().generateEmailHTML(c),o=window.open("","_blank","width=800,height=600");o.document.write(t),o.document.close(),console.log("✅ Email template preview opened in new window")}function testConsolidatedTemplates(){console.log("🧪 Testing consolidated email templates...");const c={name:"Test User",email:"test@example.com",project:"Test Project",address:"Test Address",phone:"1234567890"};try{const e=new EmailTemplateGenerator,t=e.generateEmailHTML(c),o=e.generateTextEmail(c);console.log("✅ Standalone EmailTemplateGenerator works correctly"),console.log("📄 HTML content length:",t.length),console.log("📝 Text content length:",o.length);const r=new EmailService()._generateEmailContent(c,null,null);return console.log("✅ EmailService integration works correctly"),console.log("📧 Email content generated:",{to:r.to,subject:r.subject,htmlLength:r.html.length,textLength:r.text.length}),!0}catch(e){return console.error("❌ Template consolidation test failed:",e),!1}}window.testEmailTemplate=testEmailTemplate;window.testConsolidatedTemplates=testConsolidatedTemplates;class PDFService{constructor(){this.isInitialized=!1,this.imageOptimizationStats={totalImages:0,optimizedImages:0,failedImages:0},this.imageAliasCache=new Map,this.preloadedImageCache=new Map}_generateImageHash(e){let t=0;if(!e||e.length===0)return t.toString();for(let o=0;o<e.length;o++){const s=e.charCodeAt(o);t=(t<<5)-t+s,t=t&t}return Math.abs(t).toString(36)}_isTechnicalDiagram(e,t){try{const o=Math.min(100,e.width),s=Math.min(100,e.height),n=t.getImageData(0,0,o,s).data,l=new Set;for(let i=0;i<n.length;i+=4){const a=`${n[i]},${n[i+1]},${n[i+2]}`;if(l.add(a),l.size>1e3)return!1}return l.size<1e3}catch(o){return console.warn("Could not analyze image for diagram detection:",o),!1}}_detectTransparency(e,t){try{const s=t.getImageData(0,0,e.width,e.height).data;for(let r=3;r<s.length;r+=4)if(s[r]<255)return!0;return!1}catch(o){return console.warn("Could not detect transparency:",o),!1}}async _preloadAllImages(e){this.preloadedImageCache.clear();const t=new Set;e.forEach(a=>{a.Image_URL&&a.Image_URL.length>10&&t.add(a.Image_URL),a.Diagram_URL&&a.Diagram_URL.length>10&&t.add(a.Diagram_URL)});const o=Array.from(t);if(o.length===0)return console.log("📷 No images to preload"),0;console.log(`📷 Preloading ${o.length} images in parallel...`);const s=Date.now(),r=10;let n=0,l=0;for(let a=0;a<o.length;a+=r){const d=o.slice(a,a+r);(await Promise.allSettled(d.map(p=>this._preloadSingleImage(p)))).forEach((p,m)=>{const f=d[m];p.status==="fulfilled"&&p.value?(this.preloadedImageCache.set(f,p.value),n++):l++});const h=document.getElementById("preload-progress");if(h){const p=Math.min(100,Math.round((a+d.length)/o.length*100));h.textContent=`Loading images: ${p}%`}}const i=((Date.now()-s)/1e3).toFixed(1);return console.log(`✅ Preloaded ${n}/${o.length} images in ${i}s (${l} failed)`),n}async _preloadSingleImage(e){if(this.preloadedImageCache.has(e))return this.preloadedImageCache.get(e);if(!e||typeof e!="string"||e.length<25)return null;const t=/\.(jpg|jpeg|png|gif|webp|svg)(\?.*)?$/i.test(e),o=e.startsWith("data:");if(!t&&!o)return console.warn("Skipping URL without valid extension:",e.substring(0,50)+"..."),null;if(/\/images\/\d+$/.test(e)||e.endsWith("/0"))return null;try{const s=await this._optimizeImageForPDF(e,400,.8);return s&&s.url!=="assets/no-image.png"?s:null}catch{return console.warn(`Failed to preload image: ${e.substring(0,50)}...`),null}}async init(){try{await this._loadJSPDF(),this.isInitialized=!0,console.log("✅ PDF service initialized")}catch(e){throw console.error("❌ PDF service initialization failed:",e),e}}async generatePDF(e){if(!this.isInitialized)throw new Error("PDF service not initialized");try{console.log(`📄 Generating PDF for ${dataService.getSelectionStats().totalProducts} products...`),this._ensurePdfSpinner();const t=document.getElementById("pdf-spinner");return t&&(t.style.display="flex"),this._resetImageOptimizationStats(),this._showProcessingNotification(e),await this._generatePDFWithOriginalLogic(e)}catch(t){throw console.error("❌ PDF generation failed:",t),t}}async _generatePDFWithOriginalLogic(e){var u;const t=JSON.parse(localStorage.getItem("selection")||"[]"),o=JSON.parse(localStorage.getItem(CONFIG.STORAGE_KEYS.SELECTED_PRODUCTS)||"[]");let s=[];if(o.length>0?s=o.map(h=>({...h.product,Room:h.room,Notes:h.notes,Quantity:h.quantity,Timestamp:new Date(h.timestamp).toISOString()})):s=t,!s.length){alert("No products selected.");const h=document.getElementById("pdf-spinner");h&&(h.style.display="none");return}if(this.preloadedImageCache.size>0)console.log(`📷 Using ${this.preloadedImageCache.size} pre-cached images (skipping duplicate preload)`);else{const h=document.getElementById("pdf-processing-notification");if(h){const m=document.createElement("span");m.id="preload-progress",m.style.cssText="display: block; font-size: 12px; margin-top: 4px; color: #1e40af;",m.textContent="Loading images: 0%",(u=h.querySelector("p"))==null||u.appendChild(m)}console.log("📷 Starting image preload for",s.length,"products");const p=await this._preloadAllImages(s);if(console.log(`📷 Image preloading complete: ${p} images cached`),h){const m=document.getElementById("preload-progress");m&&(m.textContent=`✓ ${p} images ready`)}}const n={};s.forEach(h=>{n[h.Room]||(n[h.Room]=[]),n[h.Room].push(h)});const{jsPDF:l}=window.jspdf,i=new l({orientation:"landscape",unit:"pt",format:"a4",compress:!0,putOnlyUsedFonts:!0,precision:16,floatPrecision:16}),a=i.internal.pageSize.getWidth(),d=i.internal.pageSize.getHeight();return new Promise((h,p)=>{this._loadImageAsDataURL("assets/seima-logo.png",(m,f,g)=>{m&&console.log(`🔍 Debug - Cover logo size: ${(m.length/1024).toFixed(1)} KB (${f}x${g})`);const w=dataService.getStaffContact();drawCoverPage(i,{pageWidth:a,pageHeight:d,seimaLogoDataUrl:m,seimaLogoNaturalW:f,seimaLogoNaturalH:g,userDetails:e,staffContact:w,footerHeight:PDF_LAYOUT.footerHeight}),i.addPage(),this._loadImageAsDataURL("assets/seima-logo-white.png",(b,y,S)=>{const v=PDF_LAYOUT.margins.left,E=PDF_LAYOUT.footerHeight,C=!e.excludePrice,M=calculateColumnLayout(a,{showRrp:!1,showPrice:C,showQty:!0,showTotal:C}),{colX:L,colW:A,headers:T,imgW:k,imgPad:B}=M,x=[];Object.keys(n).forEach(I=>{const _=n[I];_.forEach((D,j)=>{x.push({item:D,room:I,roomCount:_.length,isFirstInRoom:j===0})})});const P=PDF_LAYOUT.maxRowsPerPage,R=PDF_LAYOUT.rowPadding,F=Math.floor((d-80)/P);let O=E+8,H=0,N=0;const U=()=>{if(N>=x.length){const D=i.internal.getNumberOfPages()-1;for(let $=2;$<=D+1;$++){i.setPage($);const q=($-2)*P,Y=Math.min(q+P,x.length);let V=!1;for(let W=q;W<Y;W++)if(x[W]&&x[W].item&&hasWelsData(x[W].item)){V=!0;break}drawPDFHeader(i,{pageWidth:a,colX:L,colW:A,leftMargin:v,footerHeight:E,logoDataUrl:b,logoNaturalW:y,logoNaturalH:S,headers:T,userDetails:{...e,includeGst:!0},skipWelsHeader:!V}),drawPDFFooter(i,{pageWidth:a,pageHeight:d,leftMargin:v,footerHeight:E,pageNumber:$-1,totalPages:D})}const j=this._generatePDFFilename(e),z=i.output("blob");this._removeNotifications(),this._showImageOptimizationSummary(e.emailCompatible),console.log(`✅ PDF generated successfully: ${j} (${(z.size/1024/1024).toFixed(2)} MB)`),h(z);return}H>=P&&(i.addPage(),O=E+8,H=0);const I=x[N];if(!I||!I.item){console.warn(`⚠️ Skipping invalid row at index ${N}:`,I),N++,U();return}const _=O+F*H;I.isFirstInRoom&&drawRoomHeader(i,I.room,I.roomCount,v,_),this._drawImage(i,I.item.Image_URL||"",L[0],_+R+8,k,F-R*2,e.emailCompatible,()=>{this._drawImage(i,I.item.Diagram_URL||"",L[0]+k+B,_+R+8,k,F-R*2,e.emailCompatible,()=>{i.setFontSize(10),i.setTextColor(PDF_COLORS.textPrimary);const D=_+32,j=L[1]+A[1]/2;i.text(String(I.item.OrderCode||""),j,D+10,{align:"center"}),drawProductLinks(i,I.item,j,D+38);const z=T.indexOf("WELS")+1,$=A[2];if(drawProductDescription(i,I.item,L[2],D+10,$),z>0&&L[z]){const G=L[z]+A[z]/2;drawWelsRating(i,I.item,G,D+10)}drawProductPricing(i,I.item,L,A,T,D+10,{excludePrice:e.excludePrice,includeGst:!0}),N++,H++,setTimeout(U,10)})})};U()})})})}async _loadJSPDF(){return new Promise((e,t)=>{if(window.jsPDF){e();return}const o=document.createElement("script");o.src="https://cdnjs.cloudflare.com/ajax/libs/jspdf/2.5.1/jspdf.umd.min.js",o.onload=e,o.onerror=t,document.head.appendChild(o)})}_loadImageAsDataURL(e,t){const o=new Image;o.crossOrigin="Anonymous",o.onload=function(){const s=document.createElement("canvas"),r=s.getContext("2d"),n=400,l=150;let i=o.width,a=o.height;if(i>n||a>l){const u=n/i,h=l/a,p=Math.min(u,h);i=Math.round(i*p),a=Math.round(a*p)}s.width=i,s.height=a,r.imageSmoothingEnabled=!0,r.imageSmoothingQuality="high",r.drawImage(o,0,0,i,a);const d=s.toDataURL("image/png");console.log(`🖼️ Logo optimized: ${o.width}x${o.height} -> ${i}x${a} (${(d.length/1024).toFixed(1)}KB)`),t(d,i,a)},o.onerror=()=>t(null,0,0),o.src=e}_drawImage(e,t,o,s,r,n,l,i){if(!t||typeof t!="string"||t.length<10){i&&i();return}if(this.imageOptimizationStats.totalImages++,l){console.log("📧 Email mode: Skipping image for smaller file size"),this.imageOptimizationStats.failedImages++,i&&i();return}const a=this,u=`img_${this._generateImageHash(t)}`;let h=this.preloadedImageCache.get(t);if(!h){const p=getCachedImage(t);p&&p.dataUrl&&(h={url:p.dataUrl,format:p.format||"JPEG"})}if(h){this._addImageToPDF(e,h,o,s,r,n,u,i);return}this._optimizeImageForPDF(t,400,.8).then(p=>{if(!p||p.url==="assets/no-image.png"){a.imageOptimizationStats.failedImages++,i&&i();return}a._addImageToPDF(e,p,o,s,r,n,u,i)}).catch(p=>{console.warn("Image optimization failed:",p),a.imageOptimizationStats.failedImages++,i&&i()})}_addImageToPDF(e,t,o,s,r,n,l,i){const a=this,{url:d,format:u}=t;if(!d.startsWith("data:")){a.imageOptimizationStats.failedImages++,i&&i();return}const h=d.split(",")[1],p=h?h.length*.75:0;if(p>1048576){console.warn(`🚫 Image too large: ${Math.round(p/1024)} KB, skipping`),a.imageOptimizationStats.failedImages++,i&&i();return}const m=new Image;m.onload=function(){try{const f=m.naturalWidth/m.naturalHeight;let g=Math.min(r,120),w=Math.min(n,120);f>1?(w=g/f,w>120&&(w=120,g=w*f)):(g=w*f,g>120&&(g=120,w=g/f)),e.addImage(d,u,o,s,g,w,l,"FAST"),a.imageOptimizationStats.optimizedImages++}catch(f){console.warn("Failed to add image with aspect ratio:",f),e.addImage(d,u,o,s,Math.min(r,120),Math.min(n,120),l,"FAST"),a.imageOptimizationStats.optimizedImages++}i&&i()},m.onerror=function(){console.warn("Failed to load image for aspect ratio calculation"),e.addImage(d,u,o,s,Math.min(r,120),Math.min(n,120),l,"FAST"),a.imageOptimizationStats.optimizedImages++,i&&i()},m.src=d}_optimizeImageForPDF(e,t=400,o=.8){const s=this;return new Promise(r=>{if(!e||typeof e!="string"||!e.startsWith("http://")&&!e.startsWith("https://")&&!e.startsWith("data:")){r({url:"assets/no-image.png",format:"PNG"});return}if((u=>{if(u.length<25||/\/images\/\d+$/.test(u)||u.endsWith("/0"))return!0;const h=/\.(jpg|jpeg|png|gif|webp|svg)(\?.*)?$/i.test(u),p=u.startsWith("data:");return!h&&!p})(e)){console.warn("Skipping malformed image URL:",e.substring(0,60)+"..."),r({url:"assets/no-image.png",format:"PNG"});return}const l=["https://wsrv.nl/?url=","https://images.weserv.nl/?url=","https://api.codetabs.com/v1/proxy?quest="];let i=0,a=!1;const d=()=>{if(a)return;const u=new Image;u.crossOrigin="Anonymous";let h=null;u.onload=function(){if(!a){a=!0,h&&clearTimeout(h);try{const m=document.createElement("canvas"),f=m.getContext("2d");let g=Math.min(t,400),w=Math.min(t,400);u.width>u.height?w=Math.round(g*u.height/u.width):g=Math.round(w*u.width/u.height),(u.width>100||u.height>100)&&(g=Math.max(g,200),w=Math.max(w,200)),m.width=g,m.height=w,f.imageSmoothingEnabled=!0,f.imageSmoothingQuality="high",f.drawImage(u,0,0,g,w);let b,y;const S=s._detectTransparency(m,f),v=s._isTechnicalDiagram(m,f);if(S||v)b=m.toDataURL("image/png",.9),y="PNG";else{const E=Math.max(o,.7);b=m.toDataURL("image/jpeg",E),y="JPEG"}r({url:b,format:y})}catch(m){console.warn("Image optimization failed:",m),r({url:"assets/no-image.png",format:"PNG"})}}},u.onerror=function(){a||(h&&clearTimeout(h),i++,i<l.length?setTimeout(d,500):(a=!0,console.warn("All proxies failed for image:",e.substring(0,50)),r({url:"assets/no-image.png",format:"PNG"})))},h=setTimeout(()=>{a||(console.warn(`⏰ Timeout loading image with proxy ${i}`),u.src="",u.onload=null,u.onerror=null,i++,i<l.length?setTimeout(d,200):(a=!0,console.warn("All proxies timed out for image"),r({url:"assets/no-image.png",format:"PNG"})))},3e3);let p=e;i<l.length&&(p=l[i]+encodeURIComponent(e)),u.src=p};d()})}_generatePDFFilename(e){const t=new Date,o=String(t.getDate()).padStart(2,"0"),s=String(t.getMonth()+1).padStart(2,"0"),r=String(t.getFullYear()).slice(-2),n=String(t.getHours()).padStart(2,"0"),l=String(t.getMinutes()).padStart(2,"0");return`${(e.project||"Selection").replace(/[^a-zA-Z0-9\s]/g,"")}-${o}${s}${r}.${n}${l}.pdf`}_ensurePdfSpinner(){if(!document.getElementById("pdf-spinner")){const e=document.createElement("div");if(e.id="pdf-spinner",e.style.cssText=`
    ...
    `,document.body.appendChild(t)}_removeNotifications(e=!1){if(e){const o=document.getElementById("pdf-spinner");o&&(o.style.display="none")}const t=document.getElementById("pdf-processing-notification");t&&t.remove()}_resetImageOptimizationStats(){this.imageOptimizationStats={totalImages:0,optimizedImages:0,failedImages:0},this.imageAliasCache.clear()}_showImageOptimizationSummary(e=!1){const t=this.imageOptimizationStats;t.totalImages>0&&(console.log("🖼️ Image Optimization Summary:"),console.log(`   Total images: ${t.totalImages}`),console.log(`   Optimized: ${t.optimizedImages}`),console.log(`   Failed: ${t.failedImages}`),console.log(`   Success rate: ${(t.optimizedImages/t.totalImages*100).toFixed(1)}%`),console.log(`   Email compatible mode: ${e}`))}generateCSV(e){try{const t=dataService.getProductsLegacyFormat();if(!t.length)return console.warn("⚠️ No products found for CSV generation"),null;const o=t.map(a=>{const d=(a.RRP_INCGST||"").toString().replace(/,/g,""),u=parseFloat(d),h=isNaN(u)?"":(u*(a.Quantity||1)).toFixed(2),p=e.excludePrice,m=a["WELS STAR"]||a.WELS_STAR||a.WELS_STAR||a.WelsStar||"",f=m&&m.toString().trim()?m.toString().replace(/[^\d.]/g,"").trim():"";return{Code:this._sanitizeCSVField(a.OrderCode||""),Description:this._sanitizeCSVField(a.Description||""),"WELS Star":this._sanitizeCSVField(f),Quantity:a.Quantity||1,"Price ea inc GST":p?"0.00":a.RRP_INCGST||"","Price Total inc GST":p?"0.00":h,Notes:this._sanitizeCSVField(a.Notes||""),Room:this._sanitizeCSVField(a.Room||""),"Image URL":this._sanitizeCSVField(a.Image_URL||""),"Diagram URL":this._sanitizeCSVField(a.Diagram_URL||""),"Datasheet URL":this._sanitizeCSVField(a.Datasheet_URL||""),"Website URL":this._sanitizeCSVField(a.Website_URL||"")}}),s=window.Papa.unparse(o,{quotes:!0,quoteChar:'"',delimiter:",",header:!0,newline:`\r
`,skipEmptyLines:!1,escapeChar:'"'}),r=this._buildCustomerMetadata(e,t),n=this._formatMetadataForCSV(r),l=s+n,i=this._sanitizeCSVForEmail(l);return console.log(`✅ CSV generated successfully (${i.length} characters, includes customer metadata)`),i}catch(t){throw console.error("❌ CSV generation failed:",t),t}}_buildCustomerMetadata(e,t){const o=e.leadData||window.currentLeadData||{},s=JSON.parse(localStorage.getItem("seimaStaffContact")||"{}"),r=new Date,n=authService.getCurrentUser(),l=(n==null?void 0:n.name)||s.name||"",i=(n==null?void 0:n.email)||s.email||"",a=(n==null?void 0:n.phone)||s.mobile||"";return{_metadata:{date:r.toLocaleDateString("en-AU"),time:r.toLocaleTimeString("en-AU",{hour:"2-digit",minute:"2-digit"})},customer:{name:e.name||o.customerName||"",email:e.email||o.customerEmail||"",phone:o.customerPhone||"",type:o.customerType||"",builderName:o.builderName||"",merchantName:o.merchantName||""},project:{name:o.projectName||"",address:o.projectAddress||"",notes:o.projectNotes||""},staff:{name:l,email:i,mobile:a}}}_formatMetadataForCSV(e){return`\r
\r
"---METADATA---"\r
...
`);if(o.length>0){const r=o[0].match(/^([\d.]+(?:\s*\([^)]+\))?)/);if(r){const n=document.getElementById("version-number");n&&(n.textContent=r[1])}}}catch(e){console.warn("Could not load version:",e)}}async showRoomSelection(){try{const t=await(await fetch("screens/room-selection.html")).text();document.body.innerHTML=t,this.currentScreen="room-selection",this.renderRoomGrid();const o=document.getElementById("back-to-welcome"),s=document.getElementById("add-custom-room");o&&(o.onclick=()=>location.reload()),s&&(s.onclick=()=>this.handleAddCustomRoom())}catch(e){console.error("Failed to load room selection screen:",e)}}renderRoomGrid(){const e=document.getElementById("room-grid");if(!e)return;e.innerHTML="",CONFIG.ROOMS.PREDEFINED.forEach(o=>{const s=document.createElement("button");s.className="room-btn",s.innerHTML=`<span class="room-icon">${o.icon}</span>${o.name}`,s.onclick=()=>this.selectRoom(o.name),e.appendChild(s)}),StorageManager.getCustomRooms().forEach((o,s)=>{const r=document.createElement("button");r.className="room-btn",r.innerHTML=`<span class="room-icon">📝</span>${o.name}`,r.onclick=()=>this.selectRoom(o.name),r.ondblclick=()=>this.handleRemoveCustomRoom(s),r.title="Double-click to remove",e.appendChild(r)})}selectRoom(e){this.selectedRoom=e,this.showScannerScreen()}async showScannerScreen(){if(this._loadingScannerScreen){console.log("Scanner screen already loading");return}this._loadingScannerScreen=!0;let e=null;try{this.scannerController.stopScanning(),console.log("🎥 Requesting camera permission...");try{if(navigator.permissions&&navigator.permissions.query)try{const r=await navigator.permissions.query({name:"camera"});console.log("Camera permission status:",r.state),r.state==="granted"?console.log("✅ Camera permission already granted, skipping temp stream"):(e=await navigator.mediaDevices.getUserMedia({video:{facingMode:"environment",width:{ideal:1280},height:{ideal:720}}}),console.log("✅ Camera permission granted"),e&&(e.getTracks().forEach(n=>{n.stop()}),e=null))}catch{console.log("Permissions API query failed, requesting stream directly"),e=await navigator.mediaDevices.getUserMedia({video:{facingMode:"environment",width:{ideal:1280},height:{ideal:720}}}),console.log("✅ Camera permission granted"),e&&(e.getTracks().forEach(n=>{n.stop()}),e=null)}else e=await navigator.mediaDevices.getUserMedia({video:{facingMode:"environment",width:{ideal:1280},height:{ideal:720}}}),console.log("✅ Camera permission granted"),e&&(e.getTracks().forEach(r=>{r.stop()}),e=null)}catch(r){console.error("❌ Camera permission denied:",r),this._loadingScannerScreen=!1;let n="Camera access denied or unavailable.";r.name==="NotAllowedError"?n="Camera access denied. Please enable camera permissions in your browser settings.":r.name==="NotFoundError"?n="No camera found on this device.":r.name==="NotReadableError"&&(n="Camera is already in use by another application."),alert(n);return}const o=await(await fetch("screens/scanner.html")).text();document.body.innerHTML=o,this.currentScreen="scanner";const s=document.getElementById("current-room-badge");s&&(s.textContent=this.selectedRoom),this.setupScannerScreenHandlers(),this.showBarcodeScanOverlay(),this.scannerController.startScanning().catch(r=>{console.error("Failed to start scanner:",r)}),this.updateSelectionCount()}catch(t){console.error("Failed to load scanner screen:",t),alert("Failed to load scanner. Please try again.")}finally{e&&e.getTracks().forEach(t=>t.stop()),this._loadingScannerScreen=!1}}setupScannerScreenHandlers(){const e=document.getElementById("back-to-rooms"),t=document.getElementById("review-btn"),o=document.getElementById("text-scan-btn"),s=document.getElementById("scanner-engine-toggle");e&&(e.onclick=()=>{this.scannerController.stopScanning(),ocrService.stopScanning(),this.showRoomSelection()}),t&&(t.onclick=()=>{this.scannerController.stopScanning(),ocrService.stopScanning(),this.showReviewScreen()}),o&&(o.onclick=()=>this.startTextScanMode()),s&&(s.value=this.scannerController.scannerEngine,s.onchange=()=>{this.scannerController.setScannerEngine(s.value),this.scannerController.stopScanning(),setTimeout(()=>{this.currentScreen==="scanner"&&this.scannerController.startScanning()},100)}),this.setupProductSearch()}setupProductSearch(){const e=document.getElementById("product-search-input"),t=document.getElementById("product-search-dropdown");if(!e||!t)return;let o=[];const s=Utils.debounce(r=>{this.performProductSearch(r,t,o)},300);e.addEventListener("focus",()=>{this.scannerController.stopScanning(),setTimeout(()=>{e.scrollIntoView({behavior:"smooth",block:"center"})},100)}),e.addEventListener("blur",()=>{setTimeout(()=>{this.currentScreen==="scanner"&&this.scannerController.startScanning()},100)}),e.addEventListener("input",()=>{const r=e.value.trim();r?s(r):(t.innerHTML="",t.classList.remove("visible"))}),t.onclick=r=>{const n=r.target.closest("li[data-idx]");if(!n)return;const l=parseInt(n.getAttribute("data-idx"),10);!isNaN(l)&&o[l]&&this.showProductDetailsScreen(o[l]),t.classList.remove("visible"),e.value="",setTimeout(()=>{this.currentScreen==="scanner"&&this.scannerController.startScanning()},100)},document.addEventListener("click",r=>{!t.contains(r.target)&&r.target!==e&&t.classList.remove("visible")})}performProductSearch(e,t,o){if(!this.dataService.isLoaded){t.innerHTML="<li>Loading catalog...</li>",t.classList.add("visible");return}o.length=0,o.push(...this.dataService.searchProducts(e)),o.length===0?t.innerHTML="<li>No products found</li>":t.innerHTML=o.map((s,r)=>`<li data-idx="${r}">${s.OrderCode} - ${s.Description}</li>`).join(""),t.classList.add("visible")}async showProductDetailsScreen(e,t={}){try{const s=await(await fetch("screens/product-details.html")).text();document.body.innerHTML=s,this.currentScreen="product-details",this.currentEditSelectionId=t.mode==="edit"&&t.selectionId||null,this.populateProductDetails(e,t),this.setupProductDetailsHandlers(e,t)}catch(o){console.error("Failed to load product details screen:",o)}}populateProductDetails(e,t){const o=document.getElementById("product-image");o&&(o.src=e.Image_URL||"assets/no-image.png",o.onerror=function(){this.src="assets/no-image.png"}),document.getElementById("product-name").textContent=e.Description||"",document.getElementById("product-code").textContent=e.OrderCode?"Code: "+e.OrderCode:"";let s="",r=NaN;e.RRP_INCGST&&(r=parseFloat(e.RRP_INCGST.toString().replace(/,/g,""))),!isNaN(r)&&r>0?s=`$${r.toFixed(2)} inc GST`:s="Price unavailable",document.getElementById("product-price-inline").textContent=s,document.getElementById("product-description").textContent=e.LongDescription||"",this.setLink("datasheet-link",e.Datasheet_URL),this.setLink("diagram-link",e.Diagram_URL),this.setLink("website-link",e.Website_URL);const n=document.getElementById("diagram-link"),l=document.getElementById("datasheet-link"),i=document.getElementById("website-link");if([n,l,i].forEach(a=>{a&&(a.setAttribute("target","_blank"),a.setAttribute("rel","noopener noreferrer"))}),this.setupVariantDropdown(e,t),this.populateRoomSelect(),this.setupQuantityInput(),this.setupAnnotationField(),this.setupAnnotationCharacterCount(t),t.room){const a=document.getElementById("room-select");if(a){if(!Array.from(a.options).some(u=>u.value===t.room)){const u=document.createElement("option");u.value=t.room,u.textContent=t.room,a.appendChild(u)}a.value=t.room}}if(t.quantity){const a=document.getElementById("product-quantity");a&&(a.value=t.quantity)}t.scannedCode&&this.showScanFeedback(`Successfully scanned: ${t.scannedCode}`)}async restartTextCamera(e="Ready to capture"){try{await this.scannerController.startScanning("text"),e&&this.showScanFeedback(e)}catch(t){console.error("Failed to restart camera:",t),this.showScanFeedback("Camera error - please try again")}}populateRoomSelect(){const e=document.getElementById("room-select");if(!e)return;e.innerHTML="",CONFIG.ROOMS.PREDEFINED.forEach(s=>{const r=document.createElement("option");r.value=s.name,r.textContent=s.name,s.name===this.selectedRoom&&(r.selected=!0),e.appendChild(r)}),StorageManager.getCustomRooms().forEach(s=>{const r=document.createElement("option");r.value=s.name,r.textContent=s.name,s.name===this.selectedRoom&&(r.selected=!0),e.appendChild(r)});const o=document.createElement("option");o.value="__add_new_room__",o.textContent="+ Add New Room / Group...",o.style.fontStyle="italic",e.appendChild(o),e.removeEventListener("change",this._roomSelectHandler),this._roomSelectHandler=s=>this.handleRoomSelectChange(s),e.addEventListener("change",this._roomSelectHandler)}handleRoomSelectChange(e){const t=e.target;t.value==="__add_new_room__"&&(t.selectedIndex=0,this.showAddRoomModal(o=>{const s=o.trim();if(Array.from(t.options).map(l=>l.value.toLowerCase()).includes(s.toLowerCase())){alert("This room already exists.");const l=Array.from(t.options).find(i=>i.value.toLowerCase()===s.toLowerCase());l&&(t.value=l.value);return}StorageManager.addCustomRoom(s);const n=document.createElement("option");n.value=s,n.textContent=s,t.insertBefore(n,t.options[t.options.length-1]),t.value=s,this.selectedRoom=s}))}setupQuantityInput(){const e=document.getElementById("product-quantity");e&&(e.addEventListener("blur",()=>{let t=parseInt(e.value,10);(isNaN(t)||t<1)&&(t=1),t>999&&(t=999),e.value=t}),e.addEventListener("focus",()=>{e.select()}))}setLink(e,t){const o=document.getElementById(e);t&&t!=="#"?(o.href=t,o.style.display=""):o.style.display="none"}setupVariantDropdown(e,t){const o=document.getElementById("variant-select-row"),s=document.getElementById("variant-select");if(o&&s){let r=e.ProductName||e["Product Name"]||"";typeof r=="string"&&(r=r.trim());let n=[];r&&(n=this.dataService.getAllProducts().filter(l=>{let i=l.ProductName||l["Product Name"]||"";return typeof i=="string"&&(i=i.trim()),i&&i===r})),n.length>1?(n.sort((l,i)=>(l.Description||"").localeCompare(i.Description||"")),o.style.display="",s.innerHTML=n.map(l=>`<option value="${l.OrderCode}"${l.OrderCode===e.OrderCode?" selected":""}>${l.Description}</option>`).join(""),s.onchange=()=>{var a;const l=s.value,i=n.find(d=>d.OrderCode===l);if(i&&i.OrderCode!==e.OrderCode){const d=((a=document.getElementById("product-annotation"))==null?void 0:a.value)||t.notes||"",u=document.getElementById("product-quantity");let h=1;u&&u.value?h=Math.max(1,parseInt(u.value,10)||1):t.quantity&&(h=t.quantity);const p=document.getElementById("room-select"),m=p?p.value:t.room;this.showProductDetailsScreen(i,{...t,notes:d,quantity:h,room:m})}}):o.style.display="none"}}setupAnnotationCharacterCount(e){const t=document.getElementById("product-annotation"),o=document.getElementById("annotation-char-count");t&&o&&(t.addEventListener("input",function(){t.value=t.value.replace(/\r?\n|\r/g," "),o.textContent=t.value.length+"/140"}),t.addEventListener("keydown",function(s){s.key==="Enter"&&s.preventDefault()}),o.textContent=t.value.length+"/140",e.notes&&(t.value=e.notes,o.textContent=t.value.length+"/140"))}setupAnnotationField(){}setupProductDetailsHandlers(e,t={}){const o=document.getElementById("back-to-scanner"),s=document.getElementById("add-to-room-btn"),r=document.getElementById("delete-selection-btn");o&&(o.onclick=()=>{t.mode==="edit"?this.showReviewScreen():this.showScannerScreen()}),s&&(t.mode==="edit"&&t.selectionId?(s.textContent="Save",s.onclick=()=>this.saveEditedProduct(e,t)):(s.textContent="Add to Group",s.onclick=()=>this.addProductToSelection(e))),r&&(t.mode==="edit"&&t.selectionId?(r.style.display="block",r.onclick=()=>this.showDeleteModal(e,t)):(r.style.display="none",r.onclick=null))}saveEditedProduct(e,t){if(!t.selectionId)return;const o=document.getElementById("room-select"),s=document.getElementById("product-quantity"),r=document.getElementById("product-annotation"),n=o?o.value:"",l=s?Math.max(1,parseInt(s.value,10)||1):1,i=r?r.value:"";if(!StorageManager.updateProductDetails(t.selectionId,{product:Utils.deepClone(e),room:n,quantity:l,notes:i})){alert("Unable to save changes. Please try again.");return}this.currentEditSelectionId=null,this.showReviewScreen()}showDeleteModal(e,t){const o=document.getElementById("delete-confirm-modal");if(!o||!t.selectionId)return;const s=document.getElementById("delete-confirm-message");s&&(s.textContent="Confirm delete");const r=document.getElementById("delete-cancel-btn"),n=document.getElementById("delete-confirm-btn");r&&(r.onclick=()=>{o.style.display="none"}),n&&(n.onclick=()=>{const l=StorageManager.removeProductFromSelection(t.selectionId);if(o.style.display="none",!l){alert("Unable to remove this product. Please try again.");return}this.currentEditSelectionId=null,this.showReviewScreen()}),o.onclick=l=>{l.target===o&&(o.style.display="none")},o.style.display="flex"}escapeHtml(e){return typeof e!="string"?"":e.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#039;")}addProductToSelection(e){const t=document.getElementById("room-select"),o=document.getElementById("product-quantity"),s=document.getElementById("product-annotation"),r=t?t.value:this.selectedRoom,n=o?parseInt(o.value):1,l=s?s.value:"";StorageManager.addProductToSelection(e,l,r,n)?this.showReviewScreen():alert("Failed to add product to selection")}async showReviewScreen(){try{const t=await(await fetch("screens/review.html")).text();document.body.innerHTML=t,this.currentScreen="review",this.setupReviewScreenHandlers(),this.renderReviewList()}catch(e){console.error("Failed to load review screen:",e)}}setupReviewScreenHandlers(){const e=document.getElementById("back-to-scanner"),t=document.getElementById("add-more-btn"),o=document.getElementById("quick-pdf-btn");e&&(e.onclick=()=>this.showScannerScreen()),t&&(t.onclick=()=>this.showScannerScreen()),o&&(console.log("📧 Email button available - lead wizard integration will handle it"),window.leadWizardIntegration||(console.log("⚠️ Lead wizard integration not available, using fallback"),o.onclick=()=>this.showPdfFormModal()))}renderReviewList(){const e=document.getElementById("review-list"),t=document.getElementById("review-empty");if(!e)return;const o=StorageManager.getSelectedProducts();if(o.length===0){e.innerHTML="",t&&(t.style.display="block"),this.destroyReviewSortables();return}t&&(t.style.display="none");const s=this.groupProductsByRoom(o);e.innerHTML=Object.entries(s).map(([r,n])=>`
      <div class="review-room-group" data-room="${r}">
        ...
        ${n.map(l=>{const i=l.product,a=i.Description||i.description||i.productName||i["Product Name"]||"Product",d=i.OrderCode||i.orderCode||"",u=i.Image_URL||i.imageUrl||"assets/no-image.png",h=i.RRP_INCGST||i.rrpIncGst||i.price||"",p=l.quantity||1,m=h?parseFloat(h.toString().replace(/[^0-9.-]/g,"")):NaN,f=isNaN(m)?"":`$${m.toFixed(2)} ea`,g=l.notes?`Notes: ${l.notes}`:"",w=this.escapeHtml(a),b=this.escapeHtml(d),y=g?this.escapeHtml(g):"",S=d?`Code: ${b}`:"Code: —",v=`Qty: ${p}`,E=f||"—";return`
          <div class="review-product-card" data-id="${l.id}" data-room="${r}" aria-label="Selected product card">
            <div class="review-drag-handle" aria-label="Drag to reorder">
              <span class="drag-dot"></span>
              <span class="drag-dot"></span>
              <span class="drag-dot"></span>
            </div>
            <div class="review-card-content" data-id="${l.id}">
              ...
              <div class="review-product-info">
                ...
                <div class="review-product-meta">
                  <span class="review-product-code">${S}</span>
                  <span class="review-product-qty">${v}</span>
                  <span class="review-product-price">${E}</span>
                </div>
    ...
    `).join(""),this.setupReviewInteractions()}groupProductsByRoom(e){return e.reduce((t,o)=>{const s=o.room||"Unassigned";return t[s]||(t[s]=[]),t[s].push(o),t},{})}setupReviewInteractions(){this.setupReviewCardTaps(),this.setupDragAndDrop(),this.updateRoomEmptyStates()}destroyReviewSortables(){this.reviewSortables&&this.reviewSortables.length&&this.reviewSortables.forEach(e=>e.destroy()),this.reviewSortables=[]}setupDragAndDrop(){const e=Array.from(document.querySelectorAll(".review-room-items"));if(!e.length){this.destroyReviewSortables();return}this.destroyReviewSortables(),this.reviewSortables=e.map(t=>new Sortable(t,{group:{name:"review-rooms",pull:!0,put:!0},animation:160,draggable:".review-product-card",handle:".review-drag-handle",delay:0,delayOnTouchOnly:!1,touchStartThreshold:3,fallbackTolerance:5,fallbackOnBody:!0,ghostClass:"review-card-ghost",chosenClass:"review-card-chosen",dragClass:"review-card-dragging",onEnd:()=>this.persistReorderedProducts()}))}persistReorderedProducts(){const e=StorageManager.getSelectedProducts();if(!e.length)return;const t=new Map(e.map(r=>[r.id,r])),o=[];if(document.querySelectorAll(".review-room-group").forEach(r=>{const n=r.getAttribute("data-room")||"Unassigned";r.querySelectorAll(".review-product-card").forEach(i=>{const a=i.getAttribute("data-id"),d=t.get(a);d&&(o.push({...d,room:n}),t.delete(a))})}),t.forEach(r=>o.push(r)),!StorageManager.setSelectedProducts(o)){alert("Unable to save the new order. Please try again.");return}this.renderReviewList(),this.updateSelectionCount()}setupReviewCardTaps(){const e=document.querySelectorAll(".review-card-content"),t=10,o=300;e.forEach(s=>{let r=0,n=0,l=0,i=!1;s.addEventListener("touchstart",a=>{r=a.touches[0].clientY,n=a.touches[0].clientX,l=Date.now(),i=!0},{passive:!0}),s.addEventListener("touchmove",a=>{if(!i)return;const d=Math.abs(a.touches[0].clientY-r),u=Math.abs(a.touches[0].clientX-n);(d>t||u>t)&&(i=!1)},{passive:!0}),s.addEventListener("touchend",a=>{const d=Date.now()-l;if(i&&d<o){a.preventDefault(),a.stopPropagation();const u=s.getAttribute("data-id");u&&this.showProductQuickView(u)}i=!1},{passive:!1}),s.addEventListener("click",a=>{if(a.pointerType==="mouse"||!("ontouchstart"in window)){a.preventDefault(),a.stopPropagation();const d=s.getAttribute("data-id");d&&this.showProductQuickView(d)}})})}showProductQuickView(e){const o=StorageManager.getSelectedProducts().find(C=>C.id===e);if(!o){console.warn("Product not found for quick view:",e);return}const{product:s,notes:r,quantity:n,room:l}=o;let i=document.getElementById("product-quick-view-modal");i||(i=document.createElement("div"),i.id="product-quick-view-modal",i.className="modal",document.body.appendChild(i));const a=s.Description||s.description||s.productName||"Product",d=s.OrderCode||s.orderCode||"",u=s.Image_URL||s.imageUrl||"assets/no-image.png",h=s.Diagram_URL||s.diagramUrl||"",p=s.Datasheet_URL||s.datasheetUrl||"",m=s.Website_URL||s.websiteUrl||"",f=s.RRP_INCGST||s.rrpIncGst||s.price||"",g=f?parseFloat(f.toString().replace(/[^0-9.-]/g,"")):NaN,w=!isNaN(g)&&g>0?`$${g.toFixed(2)} inc GST`:"Price unavailable";i.innerHTML=`
      <div class="modal-content quick-view-content">
        <button class="quick-view-close" aria-label="Close">&times;</button>
        <div class="quick-view-image-section">
          <img class="quick-view-product-image" src="${this.escapeHtml(u)}" alt="${this.escapeHtml(a)}" onerror="this.src='assets/no-image.png';">
        </div>
        <div class="quick-view-details">
          ...
          <div class="quick-view-selection-info">
            <span class="quick-view-room"><strong>Room:</strong> ${this.escapeHtml(l||"Unassigned")}</span>
        ...
        <div class="quick-view-actions">
          ...
          ${p?`<a href="${this.escapeHtml(p)}" target="_blank" rel="noopener noreferrer" class="quick-view-btn datasheet-btn">
          ...
          ${m?`<a href="${this.escapeHtml(m)}" target="_blank" rel="noopener noreferrer" class="quick-view-btn website-btn">
    ...
    `,i.style.display="flex";const b=i.querySelector(".quick-view-close"),y=i.querySelector(".quick-view-edit-btn"),S=i.querySelector(".quick-view-back-btn"),v=i.querySelector(".diagram-btn"),E=()=>{i.style.display="none"};b.addEventListener("click",E),S.addEventListener("click",E),i.addEventListener("click",C=>{C.target===i&&E()}),y.addEventListener("click",()=>{E(),this.handleEditSelection(e)}),v&&v.addEventListener("click",C=>{C.preventDefault();const M=v.getAttribute("data-url");M&&this.showDiagramLightbox(M,a)})}showDiagramLightbox(e,t){let o=document.getElementById("diagram-lightbox");o||(o=document.createElement("div"),o.id="diagram-lightbox",o.className="diagram-lightbox",document.body.appendChild(o)),o.innerHTML=`
    ...
    `,document.body.appendChild(s);const r=s.querySelector("#new-room-input"),n=s.querySelector("#add-room-cancel-btn"),l=s.querySelector("#add-room-confirm-btn");setTimeout(()=>r.focus(),100);const i=()=>{s.remove()},a=()=>{const d=r.value.trim();d?(i(),e&&e(d)):(r.focus(),r.style.borderColor="#e53e3e",setTimeout(()=>r.style.borderColor="",1500))};n.addEventListener("click",()=>{i(),t&&t()}),l.addEventListener("click",a),r.addEventListener("keydown",d=>{d.key==="Enter"?(d.preventDefault(),a()):d.key==="Escape"&&(i(),t&&t())}),s.addEventListener("click",d=>{d.target===s&&(i(),t&&t())})}handleRemoveCustomRoom(e){confirm("Remove this custom room?")&&(StorageManager.removeCustomRoom(e),this.renderRoomGrid())}showClearConfirmModal(){const e=document.getElementById("clear-selection-modal");if(e){e.style.display="flex";const t=document.getElementById("modal-cancel-btn"),o=document.getElementById("modal-confirm-btn");t&&(t.onclick=()=>{e.style.display="none"}),o&&(o.onclick=()=>{StorageManager.clearAllSelections(),window.leadWizardIntegration&&(window.leadWizardIntegration.clearCurrentLeadData(),console.log("🧹 Lead data cleared with selection clear")),e.style.display="none",this.updateSelectionCount()})}}showScanFeedback(e){const t=document.getElementById("scanner-feedback");t&&(t.innerHTML=`
      ...
      `,setTimeout(()=>{t.innerHTML=""},3e3))}updateSelectionCount(){const e=document.getElementById("selection-count");e&&(e.textContent=StorageManager.getSelectionCount().toString())}setupSeimaContactModal(){const e=document.getElementById("seima-contact-modal");if(!e)return;const t=document.getElementById("staff-contact-cancel-btn"),o=document.getElementById("staff-contact-save-btn"),s=document.getElementById("staff-mode-lock");document.getElementById("app-mode-input"),document.getElementById("staff-code-submit");const r=document.getElementById("staff-code-input-container");t&&(t.onclick=()=>{e.style.display="none",r&&(r.style.display="none")}),o&&(o.onclick=()=>this.handleSeimaContactSave()),s&&(s.onclick=()=>this.handleLockClick()),r&&(r.style.display="none"),this.loadSeimaContactDetails()}showSeimaContactModal(){const e=document.getElementById("seima-contact-modal");e&&(e.style.display="flex",this.loadSeimaContactDetails())}loadSeimaContactDetails(){const e=StorageManager.getStaffContactDetails(),t=document.getElementById("staff-name"),o=document.getElementById("staff-position"),s=document.getElementById("staff-mobile"),r=document.getElementById("staff-email"),n=document.getElementById("lock-icon"),l=document.getElementById("staff-mode-lock"),i=document.getElementById("logged-in-profile-section"),a=document.getElementById("profile-avatar"),d=document.getElementById("profile-display-name"),u=document.getElementById("profile-display-email"),h=document.getElementById("edit-profile-btn"),p=authService.isLoggedIn(),m=authService.getCurrentUser();if(e&&(e.name||e.email)?(t&&e.name&&(t.value=e.name),o&&e.position&&(o.value=e.position),s&&e.mobile&&(s.value=e.mobile),r&&e.email&&(r.value=e.email)):m&&(t&&m.name&&(t.value=m.name),o&&m.position&&(o.value=m.position),r&&m.email&&(r.value=m.email),s&&m.phone&&(s.value=m.phone)),m){i&&(i.style.display="block"),d&&(d.textContent=m.name||""),u&&(u.textContent=m.email||""),a&&(a.textContent=this.getInitials(m.name)),h&&(h.onclick=()=>this.showEditProfileModal());const g=document.getElementById("change-password-btn");g&&(g.onclick=()=>{authUI.showChangePassword(()=>{console.log("📱 Password changed")})})}else i&&(i.style.display="none");n&&(n.textContent=p?"🔓":"🔒"),l&&(p?l.classList.add("unlocked"):l.classList.remove("unlocked"))}getInitials(e){if(!e)return"?";const t=e.trim().split(" ");return t.length>=2?(t[0][0]+t[t.length-1][0]).toUpperCase():t[0][0].toUpperCase()}showEditProfileModal(){authUI.showEditProfile(e=>{console.log("📱 Profile updated:",e),StorageManager.clearStaffContactDetails(),this.loadSeimaContactDetails()})}handleLockClick(){authService.isLoggedIn()?this.showExitStaffModeModal():authUI.showLogin(t=>{console.log("📱 Staff logged in:",t.email),this.updateLockUI(!0),this.loadSeimaContactDetails(),window.dispatchEvent(new CustomEvent("staffModeChanged",{detail:{mode:"staff",user:t}}))})}showExitStaffModeModal(){const e=document.getElementById("exit-staff-mode-modal");if(!e)return;e.style.display="flex";const t=document.getElementById("exit-staff-cancel-btn"),o=document.getElementById("exit-staff-confirm-btn");if(t){const s=t.cloneNode(!0);t.parentNode.replaceChild(s,t),s.onclick=()=>{e.style.display="none"}}if(o){const s=o.cloneNode(!0);o.parentNode.replaceChild(s,o),s.onclick=()=>{e.style.display="none",this.exitStaffMode()}}}handleCodeSubmit(){console.warn("handleCodeSubmit is deprecated - use authUI.showLogin() instead")}exitStaffMode(){authService.logout(),console.log("📱 Staff logged out"),StorageManager.clearStaffContactDetails(),this.updateLockUI(!1),window.dispatchEvent(new CustomEvent("staffModeChanged",{detail:{mode:"customer"}}))}updateLockUI(e){const t=document.getElementById("lock-icon"),o=document.getElementById("staff-mode-lock");t&&(t.textContent=e?"🔓":"🔒"),o&&(e?o.classList.add("unlocked"):o.classList.remove("unlocked"))}handleSeimaContactSave(){const e=document.getElementById("staff-name"),t=document.getElementById("staff-position"),o=document.getElementById("staff-mobile"),s=document.getElementById("staff-email"),r=document.getElementById("staff-code-input-container");if(!e||!o||!s)return;const n=e.value.trim(),l=(t==null?void 0:t.value.trim())||"",i=o.value.trim(),a=s.value.trim();if(!n||!i||!a){this.showStaffContactStatus("Please fill in all required fields.","error");return}if(!/^[^\s@]+@[^\s@]+\.[^\s@]+$/.test(a)){this.showStaffContactStatus("Please enter a valid email address.","error");return}const u={name:n,position:l,mobile:i,email:a};StorageManager.setStaffContactDetails(u),this.showStaffContactStatus("Contact details saved!","success"),setTimeout(()=>{const h=document.getElementById("seima-contact-modal");h&&(h.style.display="none",r&&(r.style.display="none"))},1500)}showStaffContactStatus(e,t){const o=document.getElementById("staff-details-status");o&&(o.style.display="block",o.textContent=e,t==="success"?(o.style.background="#d1fae5",o.style.border="1px solid #10b981",o.style.color="#065f46"):t==="error"&&(o.style.background="#fee2e2",o.style.border="1px solid #ef4444",o.style.color="#991b1b"),setTimeout(()=>{o.style.display="none"},5e3))}async startTextScanMode(){try{this.scannerController.stopScanning();let e=this.scannerController.videoElement;if(!e||e.paused||e.ended?(await this.scannerController.startScanning("text"),await new Promise(s=>setTimeout(s,800)),e=this.scannerController.videoElement):console.log("📷 Using existing camera stream for text mode"),!e)throw new Error("Camera not available for Text Scan");this.showTextCaptureOverlay(),this.showScanFeedback("Position product label in the center area and tap Capture");const t=document.getElementById("text-scan-btn"),o=document.getElementById("ocr-capture-btn");t&&(t.textContent="Stop Text Scan",t.onclick=()=>this.stopTextScanMode()),o&&(o.style.display="block",o.onclick=()=>this.captureTextScan())}catch(e){console.error("Failed to start Text Scan mode:",e),this.showScanFeedback("Text Scan failed: "+e.message)}}async captureTextScan(){const e=this.scannerController.videoElement;if(!e){this.showScanFeedback("Camera not available");return}const t=document.getElementById("ocr-capture-btn");t&&(t.disabled=!0,t.textContent="Processing...");try{const o=e.videoWidth||640,s=e.videoHeight||480,r=document.createElement("canvas");r.width=o,r.height=s,r.getContext("2d").drawImage(e,0,0,o,s),this.scannerController.stopScanning(),this.showScanFeedback("Processing image...");const l=await ocrService.captureAndProcessCanvas(r);if(l.length===0){this.showScanFeedback("No text detected. Try better lighting or angle."),await this.restartTextCamera(),t&&(t.disabled=!1,t.textContent="Capture");return}await this.handleOcrResults(l),t&&(t.disabled=!1,t.textContent="Capture")}catch(o){console.error("OCR capture error:",o),this.showScanFeedback("Error: "+o.message),await this.restartTextCamera(),t&&(t.disabled=!1,t.textContent="Capture")}}stopTextScanMode(){ocrService.stopScanning(),this.showBarcodeScanOverlay(),this.scannerController.videoElement&&!this.scannerController.videoElement.paused&&(this.scannerController.stopScanning(),setTimeout(()=>{this.scannerController.startScanning("barcode").catch(o=>{console.warn("Failed to restart barcode scanning:",o)})},300));const e=document.getElementById("text-scan-btn"),t=document.getElementById("ocr-capture-btn");e&&(e.textContent="Text Scan",e.onclick=()=>this.startTextScanMode()),t&&(t.style.display="none",t.disabled=!1,t.textContent="Capture"),this.showScanFeedback("Text Scan stopped")}showTextCaptureOverlay(){const e=document.getElementById("scanner-overlay");if(!e)return;const t=e.querySelector(".scan-area"),o=e.querySelector(".scan-line");t&&(t.style.display="none"),o&&(o.style.display="none");let s=e.querySelector(".text-capture-area");s||(s=document.createElement("div"),s.className="text-capture-area",e.appendChild(s)),s.style.display="block";let r=e.querySelector(".text-capture-corners");r||(r=document.createElement("div"),r.className="text-capture-corners",e.appendChild(r)),r.style.display="block";let n=e.querySelector(".text-capture-instruction");n||(n=document.createElement("div"),n.className="text-capture-instruction",n.textContent="Position product label with Order Code here",e.appendChild(n)),n.style.display="block"}showBarcodeScanOverlay(){const e=document.getElementById("scanner-overlay");if(!e)return;const t=e.querySelector(".scan-area"),o=e.querySelector(".scan-line");t&&(t.style.display="block"),o&&(o.style.display="block");const s=e.querySelector(".text-capture-area"),r=e.querySelector(".text-capture-corners"),n=e.querySelector(".text-capture-instruction");s&&(s.style.display="none"),r&&(r.style.display="none"),n&&(n.style.display="none")}async handleOcrResults(e){const t=document.getElementById("ocr-confirmation-modal");if(t&&t.style.display!=="none"){console.log("OCR modal already open, ignoring new detection");return}if(!this.dataService.isLoaded){this.showScanFeedback("Product data loading, please wait...");return}const o=this.dataService.getAllProducts(),s=OCRProductMatcher.findProductsByOcrTexts(e,o);if(s&&s.requiresSelection&&s.families)this.showProductFamilySelectionModal(s.families,e);else{const r=Array.isArray(s)?s:[];this.showOcrConfirmationModal(r,e)}}showOcrConfirmationModal(e,t){const o=document.getElementById("ocr-confirmation-modal"),s=document.getElementById("ocr-candidates-list"),r=document.getElementById("ocr-no-matches"),n=document.getElementById("ocr-confirm-btn"),l=document.getElementById("ocr-cancel-btn");if(!o||!s||!n||!l){console.error("OCR confirmation modal elements not found");return}s.innerHTML="";const i=new Set;e.length===0?(r.style.display="block",s.style.display="none",n.style.display="none"):(r.style.display="none",s.style.display="block",e.forEach((a,d)=>{const u=a.product,h=u.OrderCode||"N/A",p=u.Description||u["Product Description"]||u["Product Name"]||"No description",m=u.Image_URL||u["Image URL"]||"assets/no-image.png",f=document.createElement("div");f.style.cssText="display: flex; align-items: center; padding: 12px; border: 1px solid #ddd; border-radius: 8px; margin-bottom: 10px; cursor: pointer;",f.innerHTML=`
          ...
          <div style="flex: 1;">
            ...
            <div style="font-size: 0.9em; color: #666; margin-bottom: 4px;">${p.substring(0,60)}${p.length>60?"...":""}</div>
        ...
        `;const g=f.querySelector('input[type="checkbox"]');g.onclick=w=>{w.stopPropagation(),g.checked?i.delete(u):i.add(u),n.disabled=i.size===0},g.onchange=w=>{w.stopPropagation(),g.checked?i.add(u):i.delete(u),n.disabled=i.size===0},f.onclick=w=>{w.target!==g&&w.target!==g.parentElement&&(g.checked=!g.checked,g.checked?i.add(u):i.delete(u),n.disabled=i.size===0)},s.appendChild(f)}),n.style.display="block",n.disabled=!0),n.textContent="Add Selected",n.onclick=()=>{if(i.size===0)return;const a=Array.from(i);if(o.style.display="none",a.length===1){const d=a[0];this.showProductDetailsScreen(d,{scannedCode:d.OrderCode,fromOcr:!0})}else a.forEach(d=>{this.dataService.addProduct(d,"",this.selectedRoom||"Blank",1)}),this.showScanFeedback(`Added ${a.length} product(s) to selection`),this.updateSelectionCount(),this.showReviewScreen()},l.onclick=async()=>{o.style.display="none",await this.restartTextCamera()},l.disabled=!1,o.style.display="flex"}showProductFamilySelectionModal(e,t){const o=document.getElementById("ocr-confirmation-modal"),s=document.getElementById("ocr-candidates-list"),r=document.getElementById("ocr-no-matches"),n=document.getElementById("ocr-confirm-btn"),l=document.getElementById("ocr-cancel-btn");if(!o||!s||!n||!l){console.error("OCR confirmation modal elements not found");return}if(!e||e.length===0){console.error("❌ No families provided to selection modal!"),r.style.display="block",s.style.display="none",n.style.display="none",l.onclick=async()=>{o.style.display="none";try{await this.scannerController.startScanning("text"),this.showScanFeedback("Ready to capture")}catch(u){console.error("Failed to restart camera:",u),this.showScanFeedback("Camera error - please try again")}},l.disabled=!1,o.style.display="flex";return}const i=o.querySelector("h3"),a=o.querySelector("p");i&&(i.textContent="Multiple Products Detected"),a&&(a.textContent="Select which product you're looking for:"),s.innerHTML="",r.style.display="none",s.style.display="block",n.style.display="block";let d=null;e.forEach((u,h)=>{var b,y;const p=document.createElement("div");p.style.cssText="display: flex; align-items: center; padding: 16px; border: 2px solid #ddd; border-radius: 8px; margin-bottom: 12px; cursor: pointer; transition: all 0.2s;";const m=u.matches.length,f=u.matches[0],g=((b=f==null?void 0:f.product)==null?void 0:b.Image_URL)||((y=f==null?void 0:f.product)==null?void 0:y["Image URL"])||"assets/no-image.png";p.innerHTML=`
        ...
        <div style="flex: 1;">
          ...
          <div style="font-size: 0.9em; color: #666; margin-bottom: 4px;">${m} variant${m!==1?"s":""} found</div>
          <div style="font-size: 0.85em; color: #888;">
      ...
      `),t&&o)if(this.notFoundProducts.length>0){const r=t.querySelector("h5");r&&(r.textContent="Products added with placeholder information:",r.style.color="#2563eb");const n=this.notFoundProducts.map(l=>`<li><strong>${l.orderCode}</strong> - ${l.productName} (Qty: ${l.quantity}, Price: ${l.price})</li>`).join("");o.innerHTML=`<ul>${n}</ul>`,t.style.display="block",t.style.borderColor="#2563eb",t.style.backgroundColor="#eff6ff"}else t.style.display="none";const s=document.getElementById("import-close-btn");s&&this.processedData.length>0&&(s.textContent="View Products",s.onclick=()=>{this.closeModal(),window.navigationManager&&window.navigationManager.showReviewScreen&&window.navigationManager.showReviewScreen()}),console.log("Import results displayed")}}function configureSelectionRecorder(c){return c?(selectionRecorder.configure(c),CONFIG.SELECTION_RECORDING.GOOGLE_SHEETS_URL=c,console.log("✅ Selection recorder configured successfully"),console.log("📊 URL:",c),!0):(console.error("❌ Google Sheets URL is required"),!1)}async function testSelectionRecorder(){console.log("🧪 Testing selection recorder connection...");try{const c=await selectionRecorder.testConnection();return c.success?(console.log("✅ Selection recorder test successful!"),console.log("📊 Your Google Sheets integration is working correctly"),!0):(console.error("❌ Selection recorder test failed:",c.error),!1)}catch(c){return console.error("❌ Selection recorder test error:",c),!1}}function getSelectionRecorderStatus(){const c={enabled:selectionRecorder.isEnabled,configured:!!selectionRecorder.googleSheetsUrl,url:selectionRecorder.googleSheetsUrl?"Set":"Not set",retryAttempts:selectionRecorder.retryAttempts,retryDelay:selectionRecorder.retryDelay};return console.log("📊 Selection Recorder Status:",c),c}function toggleSelectionRecording(c=!0){return selectionRecorder.setEnabled(c),console.log(`📊 Selection recording ${c?"enabled":"disabled"}`),c}function setupSelectionRecorder(){console.log(`
...
Need help? Check SELECTION-RECORDING-SETUP.md for detailed instructions.
  `)}typeof window<"u"&&(window.configureSelectionRecorder=configureSelectionRecorder,window.testSelectionRecorder=testSelectionRecorder,window.getSelectionRecorderStatus=getSelectionRecorderStatus,window.toggleSelectionRecording=toggleSelectionRecording,window.setupSelectionRecorder=setupSelectionRecorder);class BuilderMerchantService{constructor(){this.googleSheetsUrl=CONFIG.SELECTION_RECORDING.GOOGLE_SHEETS_URL,this.cache={builders:[],merchants:[],lastFetch:null,cacheTimeout:5*60*1e3}}isCacheValid(){return this.cache.lastFetch?Date.now()-this.cache.lastFetch<this.cache.cacheTimeout:!1}async getBuilders(e=!0){if(e&&this.isCacheValid()&&this.cache.builders.length>0)return console.log("🏗️ Using cached builders list"),this.cache.builders;try{const t=`${this.googleSheetsUrl}?action=getBuilders`,s=await(await fetch(t)).json();if(s.success)return this.cache.builders=s.builders||[],this.cache.builders.sort((r,n)=>r.toLowerCase().localeCompare(n.toLowerCase())),this.cache.lastFetch=Date.now(),console.log(`🏗️ Fetched ${this.cache.builders.length} builders from server`),this.cache.builders;throw new Error(s.error||"Failed to fetch builders")}catch(t){return console.error("❌ Error fetching builders:",t),this.cache.builders.length>0?(console.log("🏗️ Using stale cached builders due to error"),this.cache.builders):[]}}async getMerchants(e=!0){if(e&&this.isCacheValid()&&this.cache.merchants.length>0)return console.log("🏪 Using cached merchants list"),this.cache.merchants;try{const t=`${this.googleSheetsUrl}?action=getMerchants`,s=await(await fetch(t)).json();if(s.success)return this.cache.merchants=s.merchants||[],this.cache.merchants.sort((r,n)=>r.toLowerCase().localeCompare(n.toLowerCase())),this.cache.lastFetch=Date.now(),console.log(`🏪 Fetched ${this.cache.merchants.length} merchants from server`),this.cache.merchants;throw new Error(s.error||"Failed to fetch merchants")}catch(t){return console.error("❌ Error fetching merchants:",t),this.cache.merchants.length>0?(console.log("🏪 Using stale cached merchants due to error"),this.cache.merchants):[]}}async searchBuilders(e){if(!e||e.trim()==="")return await this.getBuilders();try{const t=`${this.googleSheetsUrl}?action=searchBuilders&query=${encodeURIComponent(e)}`,s=await(await fetch(t)).json();if(s.success){const r=s.builders||[];return r.sort((n,l)=>n.toLowerCase().localeCompare(l.toLowerCase())),console.log(`🔍 Found ${r.length} builders matching "${e}"`),r}else throw new Error(s.error||"Failed to search builders")}catch(t){console.error("❌ Error searching builders:",t);const o=await this.getBuilders(),s=e.toLowerCase();return o.filter(n=>n.toLowerCase().includes(s)).sort((n,l)=>n.toLowerCase().localeCompare(l.toLowerCase()))}}async searchMerchants(e){if(!e||e.trim()==="")return await this.getMerchants();try{const t=`${this.googleSheetsUrl}?action=searchMerchants&query=${encodeURIComponent(e)}`,s=await(await fetch(t)).json();if(s.success){const r=s.merchants||[];return r.sort((n,l)=>n.toLowerCase().localeCompare(l.toLowerCase())),console.log(`🔍 Found ${r.length} merchants matching "${e}"`),r}else throw new Error(s.error||"Failed to search merchants")}catch(t){console.error("❌ Error searching merchants:",t);const o=await this.getMerchants(),s=e.toLowerCase();return o.filter(n=>n.toLowerCase().includes(s)).sort((n,l)=>n.toLowerCase().localeCompare(l.toLowerCase()))}}async addBuilder(e){if(!e||e.trim()==="")return{success:!1,error:"Builder name is required"};try{const t=`${this.googleSheetsUrl}?action=addBuilder&name=${encodeURIComponent(e.trim())}`,s=await(await fetch(t)).json();return s.success?(this.cache.lastFetch=null,console.log(`✅ Builder "${s.name}" added successfully`),s):(console.log(`⚠️ Builder add failed: ${s.error}`),s.existing&&console.log(`💡 Suggested existing: "${s.existing}"`),s)}catch(t){return console.error("❌ Error adding builder:",t),{success:!1,error:t.message}}}async addMerchant(e){if(!e||e.trim()==="")return{success:!1,error:"Merchant name is required"};try{const t=`${this.googleSheetsUrl}?action=addMerchant&name=${encodeURIComponent(e.trim())}`,s=await(await fetch(t)).json();return s.success?(this.cache.lastFetch=null,console.log(`✅ Merchant "${s.name}" added successfully`),s):(console.log(`⚠️ Merchant add failed: ${s.error}`),s.existing&&console.log(`💡 Suggested existing: "${s.existing}"`),s)}catch(t){return console.error("❌ Error adding merchant:",t),{success:!1,error:t.message}}}clearCache(){this.cache={builders:[],merchants:[],lastFetch:null,cacheTimeout:5*60*1e3},console.log("🧹 Builder/Merchant cache cleared")}getCacheStatus(){return{builders:this.cache.builders.length,merchants:this.cache.merchants.length,lastFetch:this.cache.lastFetch?new Date(this.cache.lastFetch).toLocaleString():"Never",isValid:this.isCacheValid()}}}const builderMerchantService=new BuilderMerchantService;window.testBuilderMerchantService=async()=>{console.log("🧪 Testing Builder/Merchant Service...");try{const c=await builderMerchantService.getBuilders();console.log("✅ Builders:",c);const e=await builderMerchantService.getMerchants();return console.log("✅ Merchants:",e),console.log("✅ Builder/Merchant Service test completed"),!0}catch(c){return console.error("❌ Builder/Merchant Service test failed:",c),!1}};window.clearBuilderMerchantCache=()=>(builderMerchantService.clearCache(),"Cache cleared successfully");window.getBuilderMerchantStatus=()=>{const c=builderMerchantService.getCacheStatus();return console.log("📊 Builder/Merchant Service Status:",c),c};class LeadTracker{constructor(){this.leadData={customerName:"",customerEmail:"",customerPhone:"",projectName:"",projectAddress:"",projectNotes:"",excludePrice:!1,exportCsv:!0,customerType:null,customerTypeOther:"",builderName:"",merchantName:"",hearAboutUs:[],hearAboutUsOther:"",referralBuilder:"",referralMerchant:""},this.builderList=[],this.merchantList=[],this.currentStep=1,this.totalSteps=3}getLeadData(){return{...this.leadData}}updateLeadData(e){this.leadData={...this.leadData,...e}}clearLeadData(){this.leadData={customerName:"",customerEmail:"",customerPhone:"",projectName:"",projectAddress:"",projectNotes:"",excludePrice:!1,exportCsv:!0,customerType:null,customerTypeOther:"",builderName:"",merchantName:"",hearAboutUs:[],hearAboutUsOther:"",referralBuilder:"",referralMerchant:""},this.currentStep=1}validateStep(e){switch(e){case 1:return this.leadData.customerName&&this.leadData.customerEmail&&this.leadData.projectName;case 2:return this.leadData.customerType!==null;case 3:return this.leadData.hearAboutUs.length>0;default:return!1}}validateForm(){const e=authService.isLoggedIn();return this.leadData.customerName&&this.leadData.customerEmail&&this.leadData.projectName?e?this.leadData.customerType!==null&&this.leadData.hearAboutUs.length>0:!0:!1}getFormattedLeadData(){const e=this.leadData;let t=e.customerType;e.customerType==="Other"&&e.customerTypeOther&&(t=e.customerTypeOther);let o=[...e.hearAboutUs];if(e.hearAboutUs.includes("Other")&&e.hearAboutUsOther){const s=o.indexOf("Other");o[s]=`Other (${e.hearAboutUsOther})`}return{customerType:t,hearAboutUs:o.join(", "),customerTypeRaw:e.customerType,hearAboutUsArray:e.hearAboutUs,builderName:e.builderName,merchantName:e.merchantName,referralBuilder:e.referralBuilder,referralMerchant:e.referralMerchant,projectNotes:e.projectNotes||""}}getBuilderList(){return[...this.builderList]}getMerchantList(){return[...this.merchantList]}async getBuilderList(){return await builderMerchantService.getBuilders()}async getMerchantList(){return await builderMerchantService.getMerchants()}async searchBuilders(e){return await builderMerchantService.searchBuilders(e)}async searchMerchants(e){return await builderMerchantService.searchMerchants(e)}async addCustomBuilder(e){return await builderMerchantService.addBuilder(e)}async addCustomMerchant(e){return await builderMerchantService.addMerchant(e)}loadCustomLists(){try{const e=localStorage.getItem("customBuilders");e&&(this.builderList=JSON.parse(e));const t=localStorage.getItem("customMerchants");t&&(this.merchantList=JSON.parse(t))}catch(e){console.error("Error loading custom lists:",e)}}clearCustomLists(){this.builderList=[],this.merchantList=[],localStorage.removeItem("customBuilders"),localStorage.removeItem("customMerchants"),console.log("🧹 Cleared all custom builder and merchant lists")}}const leadTracker=new LeadTracker;leadTracker.loadCustomLists();window.clearBuilderMerchantLists=()=>(leadTracker.clearCustomLists(),"Builder and merchant lists cleared. Refresh the page to see empty lists.");class SelectionLoader{constructor(){var e;this.googleSheetsUrl=((e=CONFIG.SELECTION_RECORDING)==null?void 0:e.GOOGLE_SHEETS_URL)||null,this.cachedSelections=null,this.cachedDeletedSelections=null,this.cacheTimestamp=null,this.deletedCacheTimestamp=null,this.cacheDuration=5*60*1e3}isStaffMode(){return authService.isLoggedIn()}async fetchSelections(e=!1){if(!this.googleSheetsUrl)return console.error("❌ Google Sheets URL not configured"),[];if(e){if(this.cachedDeletedSelections&&this.deletedCacheTimestamp&&Date.now()-this.deletedCacheTimestamp<this.cacheDuration)return console.log("📊 Using cached deleted selections"),this.cachedDeletedSelections}else if(this.cachedSelections&&this.cacheTimestamp&&Date.now()-this.cacheTimestamp<this.cacheDuration)return console.log("📊 Using cached selections"),this.cachedSelections;try{const t=authService.getCurrentUser(),o=(t==null?void 0:t.email)||"";console.log(`📊 Fetching ${e?"deleted ":""}selections for ${o||"all staff"}...`);const s=new URL(this.googleSheetsUrl);s.searchParams.append("action","getSelections"),s.searchParams.append("monthsBack","0"),e&&s.searchParams.append("deletedOnly","true"),o&&s.searchParams.append("staffEmail",o);const r=await fetch(s.toString(),{method:"GET",headers:{Accept:"application/json"}});if(!r.ok)throw new Error(`HTTP ${r.status}: ${r.statusText}`);const n=await r.json();if(n.success&&n.selections)return console.log(`✅ Fetched ${n.selections.length} ${e?"deleted ":""}selections`),e?(this.cachedDeletedSelections=n.selections,this.deletedCacheTimestamp=Date.now()):(this.cachedSelections=n.selections,this.cacheTimestamp=Date.now()),n.selections;throw new Error(n.error||"Failed to fetch selections")}catch(t){return console.error("❌ Error fetching selections:",t),[]}}searchSelections(e,t){if(!t||t.trim()==="")return e;const o=t.toLowerCase().trim();return e.filter(s=>{const r=(s.customerName||"").toLowerCase(),n=(s.customerProject||"").toLowerCase(),l=(s.date||"").toLowerCase();return r.includes(o)||n.includes(o)||l.includes(o)})}sortByDateDescending(e){return[...e].sort((t,o)=>{try{const s=this.parseDateValue(t.date,t.time);return this.parseDateValue(o.date,o.time)-s}catch{return 0}})}parseDateValue(e,t){if(!e)return new Date(0);const o=String(e);let s=null;const r=o.split("/");if(r.length===3&&r[0].length<=2)s=new Date(parseInt(r[2]),parseInt(r[1])-1,parseInt(r[0]));else if(s=new Date(o),isNaN(s.getTime())||s.getFullYear()<=1900)return new Date(0);if(t){const n=this.extractTimeString(t);if(n){const l=n.split(":");l.length>=2&&(s.setHours(parseInt(l[0])||0),s.setMinutes(parseInt(l[1])||0))}}return s}extractTimeString(e){if(!e)return"";const t=String(e),o=t.match(/^(\d{1,2}:\d{2})(:\d{2})?$/);if(o)return o[1];const s=t.match(/(\d{1,2}:\d{2}):\d{2}/);if(s)return s[1];const r=t.match(/(\d{1,2}:\d{2})/);return r?r[1]:""}async loadSelection(e){try{console.log("📦 Loading selection:",e);let t=[];if(e.productsJson)try{t=JSON.parse(e.productsJson)}catch(l){return console.error("❌ Failed to parse products JSON:",l),{success:!1,error:"Failed to parse saved products"}}if(t.length===0)return{success:!1,error:"No products found in this selection"};const o=[],s=dataService.getAllProducts(),r=[];for(const l of t){let i=s.find(u=>u.OrderCode===l.orderCode||u.orderCode===l.orderCode),a;i?a=i:(console.warn(`⚠️ Product ${l.orderCode} not found in catalog, using saved data`),r.push(l.orderCode),a={OrderCode:l.orderCode,Description:l.description||"Product no longer in catalogue",RRP_INCGST:l.priceIncGst||"0.00",Image_URL:"assets/no-image.png",_notInCatalog:!0});const d={id:this.generateId(),product:a,notes:l.notes||"",room:l.room||"Blank",quantity:l.quantity||1,timestamp:Date.now()};o.push(d)}StorageManager.setSelectedProducts(o),console.log(`✅ Loaded ${o.length} products`),this.loadCustomerDetails(e);const n={success:!0,productsLoaded:o.length,notFoundProducts:r};return r.length>0&&(n.warning=`${r.length} product(s) are no longer in the catalogue`),n}catch(t){return console.error("❌ Error loading selection:",t),{success:!1,error:t.message}}}loadCustomerDetails(e){const t={customerName:e.customerName||"",customerEmail:e.customerEmail||"",customerPhone:this.cleanPhoneNumber(e.customerPhone),projectName:e.customerProject||"",projectAddress:e.customerAddress||"",projectNotes:e.projectNotes||"",customerType:e.customerType||null,builderName:e.builderName||"",merchantName:e.merchantName||"",hearAboutUs:e.hearAboutUs?e.hearAboutUs.split(", ").filter(o=>o):[],referralBuilder:e.referralBuilder||"",referralMerchant:e.referralMerchant||""};leadTracker.updateLeadData(t);try{localStorage.setItem("loadedSelectionCustomerData",JSON.stringify(t)),console.log("✅ Customer details saved to localStorage")}catch(o){console.warn("⚠️ Could not save customer data to localStorage:",o)}console.log("✅ Customer details loaded into lead tracker:",t)}generateId(){return"sel_"+Date.now().toString(36)+"_"+Math.random().toString(36).substr(2,9)}cleanPhoneNumber(e){if(!e)return"";let t=String(e).trim();return t.startsWith("'")&&(t=t.substring(1)),/^4\d{8}$/.test(t)&&(t="0"+t),t}clearCache(){this.cachedSelections=null,this.cacheTimestamp=null,this.cachedDeletedSelections=null,this.deletedCacheTimestamp=null}async deleteSelections(e){if(!this.googleSheetsUrl)return console.error("❌ Google Sheets URL not configured"),{success:!1,error:"Google Sheets URL not configured"};if(!e||e.length===0)return{success:!1,error:"No selections provided"};try{console.log(`🗑️ Deleting ${e.length} selection(s)...`);const t=e.map(n=>({date:n.date||"",time:n.time||"",customerName:n.customerName||"",customerEmail:n.customerEmail||""})),o=new URL(this.googleSheetsUrl),s=await fetch(o.toString(),{method:"POST",headers:{"Content-Type":"application/x-www-form-urlencoded"},body:new URLSearchParams({data:JSON.stringify({action:"deleteSelections",selections:t})})});if(!s.ok)throw new Error(`HTTP ${s.status}: ${s.statusText}`);const r=await s.json();if(r.success)return console.log(`✅ Deleted ${r.deletedCount||e.length} selection(s)`),this.clearCache(),{success:!0,deletedCount:r.deletedCount||e.length};throw new Error(r.error||"Failed to delete selections")}catch(t){return console.error("❌ Error deleting selections:",t),{success:!1,error:t.message}}}async restoreSelections(e){if(!this.googleSheetsUrl)return console.error("❌ Google Sheets URL not configured"),{success:!1,error:"Google Sheets URL not configured"};if(!e||e.length===0)return{success:!1,error:"No selections provided"};try{console.log(`♻️ Restoring ${e.length} selection(s)...`);const t=e.map(n=>({date:n.date||"",time:n.time||"",customerName:n.customerName||"",customerEmail:n.customerEmail||""})),o=new URL(this.googleSheetsUrl),s=await fetch(o.toString(),{method:"POST",headers:{"Content-Type":"application/x-www-form-urlencoded"},body:new URLSearchParams({data:JSON.stringify({action:"restoreSelections",selections:t})})});if(!s.ok)throw new Error(`HTTP ${s.status}: ${s.statusText}`);const r=await s.json();if(r.success)return console.log(`✅ Restored ${r.restoredCount||e.length} selection(s)`),this.clearCache(),{success:!0,restoredCount:r.restoredCount||e.length};throw new Error(r.error||"Failed to restore selections")}catch(t){return console.error("❌ Error restoring selections:",t),{success:!1,error:t.message}}}formatDisplayDateShort(e){const t=this.formatDisplayDate(e);if(!t)return"";const o=t.split("/");return o.length===3&&o[2].length===4?`${o[0]}/${o[1]}/${o[2].substring(2)}`:t}formatDisplayTime(e){const t=this.extractTimeString(e);if(!t)return"";const o=t.split(":");if(o.length>=2){const s=o[0].padStart(2,"0"),r=o[1].padStart(2,"0");return`${s}:${r}`}return t}formatDisplayDate(e){if(!e)return"";const t=String(e);try{const o=t.split("/");if(o.length===3&&o[0].length<=2){const l=o[0].padStart(2,"0"),i=o[1].padStart(2,"0"),a=o[2];return`${l}/${i}/${a}`}const s=new Date(t);if(!isNaN(s.getTime())){const l=s.getFullYear();if(l>1900&&l<2100){const i=String(s.getDate()).padStart(2,"0"),a=String(s.getMonth()+1).padStart(2,"0");return`${i}/${a}/${l}`}}const r=["Jan","Feb","Mar","Apr","May","Jun","Jul","Aug","Sep","Oct","Nov","Dec"],n=t.match(/(\w{3})\s+(\d{1,2})\s+(\d{4})/);if(n){const l=r.indexOf(n[1]);if(l!==-1){const i=n[2].padStart(2,"0"),a=String(l+1).padStart(2,"0"),d=n[3];return`${i}/${a}/${d}`}}}catch(o){console.warn("Date parsing error:",o)}return t}}const selectionLoader=new SelectionLoader;typeof window<"u"&&(window.selectionLoader=selectionLoader);class SelectionPicker{constructor(){this.isVisible=!1,this.allSelections=[],this.filteredSelections=[],this.currentSearchQuery="",this.onLoadCallback=null,this.selectedItems=new Set,this.showDeletedMode=!1}isStaffMode(){return authService.isLoggedIn()}async show(e){this.onLoadCallback=e,this.selectedItems.clear(),this.showDeletedMode=!1,this.createModalHTML(),this.attachEventListeners(),this.isVisible=!0,this.setLoadingState(!0),await this.fetchAndRenderSelections()}async fetchAndRenderSelections(){this.setLoadingState(!0),this.selectedItems.clear();try{this.allSelections=await selectionLoader.fetchSelections(this.showDeletedMode),this.allSelections=selectionLoader.sortByDateDescending(this.allSelections),this.filterAndRender()}catch(e){console.error("Error fetching selections:",e),this.showError("Failed to load selections. Please try again.")}finally{this.setLoadingState(!1)}}hide(){const e=document.getElementById("selection-picker-modal");e&&e.remove(),this.isVisible=!1}createModalHTML(){const e=document.getElementById("selection-picker-modal");e&&e.remove();const t=this.isStaffMode(),o=t?'<th class="col-checkbox"><input type="checkbox" id="selection-select-all" title="Select all"></th>':"",s=t?`<label class="show-deleted-toggle">
    ...
    `;document.body.insertAdjacentHTML("beforeend",r)}attachEventListeners(){const e=document.getElementById("selection-picker-modal"),t=document.getElementById("selection-picker-close"),o=document.getElementById("selection-picker-cancel"),s=document.getElementById("selection-search-input"),r=document.getElementById("selection-retry-btn"),n=document.getElementById("selection-select-all"),l=document.getElementById("selection-delete-btn"),i=document.getElementById("selection-restore-btn"),a=document.getElementById("selection-show-deleted");t&&(t.onclick=()=>this.hide()),o&&(o.onclick=()=>this.hide()),e&&(e.onclick=u=>{u.target===e&&this.hide()}),s&&(s.oninput=u=>{this.currentSearchQuery=u.target.value,this.selectedItems.clear(),this.filterAndRender()}),r&&(r.onclick=()=>{selectionLoader.clearCache(),this.show(this.onLoadCallback)}),n&&(n.onchange=u=>{this.toggleSelectAll(u.target.checked)}),l&&(l.onclick=()=>{this.confirmDeleteSelected()});const d=document.getElementById("selection-load-btn");d&&(d.onclick=()=>{this.loadSelectedItem()}),i&&(i.onclick=()=>{this.confirmRestoreSelected()}),a&&(a.onchange=async u=>{this.showDeletedMode=u.target.checked;const h=this.currentSearchQuery;selectionLoader.clearCache(),this.createModalHTML(),this.attachEventListeners();const p=document.getElementById("selection-search-input");p&&(p.value=h),this.currentSearchQuery=h,await this.fetchAndRenderSelections()})}setLoadingState(e){const t=document.getElementById("selection-picker-loading"),o=document.getElementById("selection-picker-table-container"),s=document.getElementById("selection-picker-error"),r=document.getElementById("selection-picker-empty");t&&(t.style.display=e?"flex":"none"),o&&(o.style.display=e?"none":"block"),s&&(s.style.display="none"),r&&(r.style.display="none")}showError(e){const t=document.getElementById("selection-picker-loading"),o=document.getElementById("selection-picker-table-container"),s=document.getElementById("selection-picker-error"),r=document.getElementById("selection-error-message"),n=document.getElementById("selection-picker-empty");t&&(t.style.display="none"),o&&(o.style.display="none"),s&&(s.style.display="flex"),r&&(r.textContent=e),n&&(n.style.display="none")}filterAndRender(){let e=[...this.allSelections];const t=authService.getCurrentUser();if(t&&t.email){const o=t.email.toLowerCase();e=e.filter(s=>{const r=(s.loggedInAs||"").toLowerCase(),n=(s.staffEmail||"").toLowerCase();return r===o||n===o})}this.currentSearchQuery&&(e=selectionLoader.searchSelections(e,this.currentSearchQuery)),this.filteredSelections=e,this.renderSelectionTable()}renderSelectionTable(){const e=document.getElementById("selection-picker-tbody"),t=document.getElementById("selection-picker-table-container"),o=document.getElementById("selection-picker-empty"),s=document.getElementById("selection-count-info"),r=this.isStaffMode();if(!e)return;if(s){const i=this.filteredSelections.length;this.currentSearchQuery?s.textContent=`Showing ${i} selection${i!==1?"s":""}`:s.textContent=`${i} selection${i!==1?"s":""} found`}if(this.filteredSelections.length===0){t&&(t.style.display="none"),o&&(o.style.display="block",this.currentSearchQuery?o.querySelector("p").textContent=`No selections found matching "${this.currentSearchQuery}"`:o.querySelector("p").textContent="No selections found."),this.updateActionButton();return}t&&(t.style.display="block"),o&&(o.style.display="none");const n=this.selectedItems.size;e.innerHTML=this.filteredSelections.map((i,a)=>{const d=selectionLoader.formatDisplayDateShort(i.date),u=selectionLoader.formatDisplayTime(i.time),h=this.escapeHtml(i.customerName||"Unknown"),p=this.escapeHtml(i.customerProject||""),m=this.selectedItems.has(a),f=this.showDeletedMode,g=r?`<td class="col-checkbox"><input type="checkbox" class="selection-checkbox" data-index="${a}" ${m?"checked":""}></td>`:"";let w="selection-row";return m&&(this.showDeletedMode?w+=" selected-for-restore":n===1?w+=" selected-for-load":w+=" selected-for-deletion"),f&&(w+=" deleted-item"),`
        <tr class="${w}" data-index="${a}">
          ${g}
          <td class="col-datetime">${d} ${u}</td>
          <td class="col-customer-project">
            <div class="customer-name">${h}</div>
            ${p?`<div class="project-name">${p}</div>`:""}
          </td>
        </tr>
      `}).join(""),e.querySelectorAll(".selection-row").forEach(i=>{i.onclick=a=>{if(a.target.type==="checkbox"||this.showDeletedMode)return;const d=parseInt(i.getAttribute("data-index"),10);!isNaN(d)&&this.filteredSelections[d]&&this.confirmAndLoadSelection(this.filteredSelections[d])}}),r&&e.querySelectorAll(".selection-checkbox").forEach(a=>{a.onchange=d=>{const u=parseInt(a.getAttribute("data-index"),10);this.toggleSelection(u,d.target.checked)}}),this.updateActionButton(),this.updateSelectAllCheckbox()}loadSelectedItem(){if(this.selectedItems.size!==1)return;const e=[...this.selectedItems][0],t=this.filteredSelections[e];t&&this.confirmAndLoadSelection(t)}confirmAndLoadSelection(e){const t=StorageManager.getSelectedProducts(),o=t.length>0,s=e.customerName||"Unknown",r=e.totalProducts||0,n=selectionLoader.formatDisplayDateShort(e.date);this.showConfirmationModal(s,n,r,o,t.length,e)}showConfirmationModal(e,t,o,s,r,n){const l=s?`<div style="background: #fef3c7; border: 1px solid #f59e0b; border-radius: 8px; padding: 12px; margin-top: 16px;">
    ...
    `;document.body.insertAdjacentHTML("beforeend",i);const a=document.getElementById("selection-confirm-modal"),d=document.getElementById("confirm-cancel-btn"),u=document.getElementById("confirm-load-btn");d.onclick=()=>{a.remove()},u.onclick=async()=>{u.disabled=!0,u.textContent="Loading...";try{const h=await selectionLoader.loadSelection(n);a.remove(),this.hide(),h.success?this.showResultModal(!0,h.productsLoaded,h.warning):this.showResultModal(!1,0,h.error)}catch(h){console.error("Error loading selection:",h),a.remove(),this.showResultModal(!1,0,h.message)}},a.onclick=h=>{h.target===a&&a.remove()}}showResultModal(e,t,o){const s=e?"✅":"❌",r=e?"Selection Loaded":"Load Failed",n=e?`Successfully loaded ${t} product${t!==1?"s":""}.`:"Failed to load selection.",l=o&&e?`<div style="background: #fef3c7; border: 1px solid #f59e0b; border-radius: 8px; padding: 12px; margin-top: 16px;">
           <span style="font-size: 16px; margin-right: 8px;">⚠️</span>
    ...
    `;document.body.insertAdjacentHTML("beforeend",r);const n=document.getElementById("selection-delete-confirm-modal"),l=document.getElementById("delete-cancel-btn"),i=document.getElementById("delete-confirm-btn");l.onclick=()=>{n.remove()},i.onclick=async()=>{i.disabled=!0,i.textContent="Deleting...";try{const a=await selectionLoader.deleteSelections(t);if(n.remove(),a.success){this.selectedItems.clear(),selectionLoader.clearCache();const d=new Set(t);this.allSelections=this.allSelections.filter(u=>!d.has(u)),this.filteredSelections=this.filteredSelections.filter(u=>!d.has(u)),this.renderSelectionTable(),this.showActionResultModal("delete",!0,a.deletedCount)}else this.showActionResultModal("delete",!1,0,a.error)}catch(a){console.error("Error deleting selections:",a),n.remove(),this.showActionResultModal("delete",!1,0,a.message)}},n.onclick=a=>{a.target===n&&n.remove()}}confirmRestoreSelected(){const e=this.selectedItems.size;if(e===0)return;const t=[];this.selectedItems.forEach(a=>{this.filteredSelections[a]&&t.push(this.filteredSelections[a])});const o=t.map(a=>a.customerName||"Unknown").slice(0,3).join(", "),s=t.length>3?` and ${t.length-3} more...`:"",r=`
    ...
    `;document.body.insertAdjacentHTML("beforeend",r);const n=document.getElementById("selection-restore-confirm-modal"),l=document.getElementById("restore-cancel-btn"),i=document.getElementById("restore-confirm-btn");l.onclick=()=>{n.remove()},i.onclick=async()=>{i.disabled=!0,i.textContent="Restoring...";try{const a=await selectionLoader.restoreSelections(t);if(n.remove(),a.success){this.selectedItems.clear(),selectionLoader.clearCache();const d=new Set(t);this.allSelections=this.allSelections.filter(u=>!d.has(u)),this.filteredSelections=this.filteredSelections.filter(u=>!d.has(u)),this.renderSelectionTable(),this.showActionResultModal("restore",!0,a.restoredCount)}else this.showActionResultModal("restore",!1,0,a.error)}catch(a){console.error("Error restoring selections:",a),n.remove(),this.showActionResultModal("restore",!1,0,a.message)}},n.onclick=a=>{a.target===n&&n.remove()}}showActionResultModal(e,t,o,s){const r=e==="delete",n=t?"✅":"❌",l=t?r?"Moved to Bin":"Restored Successfully":r?"Deletion Failed":"Restore Failed",i=t?r?`Successfully moved ${o} selection${o!==1?"s":""} to the bin.`:`Successfully restored ${o} selection${o!==1?"s":""}.`:r?"Failed to delete selections.":"Failed to restore selections.",a=s?`<p style="color: #dc2626; margin-top: 12px;">${this.escapeHtml(s)}</p>`:"",d=`
      <div id="selection-action-result-modal" class="modal" style="display: flex; z-index: 1200;">
        <div class="modal-content" style="max-width: 400px; text-align: center;">
          ...
          <h3 style="margin: 0 0 16px 0; color: #333;">${l}</h3>
    ...
    `;document.body.insertAdjacentHTML("beforeend",o);const s=document.getElementById(`add-${e.toLowerCase()}-modal`),r=document.getElementById(`new-${e.toLowerCase()}-name`),n=document.getElementById(`cancel-add-${e.toLowerCase()}`),l=document.getElementById(`save-add-${e.toLowerCase()}`);setTimeout(()=>r.focus(),100);const i=async()=>{const a=r.value.trim();if(a){l.disabled=!0,l.textContent="Adding...";try{await t(a)!==!1?s.remove():(l.disabled=!1,l.textContent=`Add ${e}`)}catch(d){console.error(`❌ Error adding ${e.toLowerCase()}:`,d),l.disabled=!1,l.textContent=`Add ${e}`}}else r.focus()};return l.addEventListener("click",i),n.addEventListener("click",()=>s.remove()),r.addEventListener("keypress",a=>{a.key==="Enter"&&(a.preventDefault(),i())}),s.addEventListener("click",a=>{a.target===s&&s.remove()}),s}showDuplicateModal(e,t,o){const s=`
